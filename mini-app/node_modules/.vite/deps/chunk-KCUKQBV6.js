...
} from "./chunk-7HD3Q6GG.js";
import {
  require_jsx_runtime
} from "./chunk-RVMD3QXK.js";
import {
  require_react
} from "./chunk-W6DR7YUM.js";
import {
  __toESM
...
var Typography = (_param) => {
  var { weight, useAccentWeight, Component: Component2 = "span", normalize, inline: inline3 } = _param, restProps = _object_without_properties(_param, [
    "weight",
    "useAccentWeight",
    "Component",
    "normalize",
  ...
  return (0, import_jsx_runtime10.jsx)(RootComponent, _object_spread({
    ...
    baseClassName: clsx("vkuiTypography__host", normalize && "vkuiTypography__normalize", inline3 && "vkuiTypography__inline", weightClassNames(weight, useAccentWeight))
  }, restProps));
};
...
function DevelopmentCheck({ children }) {
  const { size: size4 } = React31.useContext(ImageBaseContext);
  if (children) {
...
function DevelopmentCheck2({ children }) {
  const { size: size4 } = React36.useContext(ImageBaseContext);
  if (true) {
    if (children) {
...
var ImageBase = (_param) => {
  ...
  const imgStyles = objectPosition || filter2 ? {
...
// node_modules/@vkontakte/vkui-date-fns-tz/constants/index.js
...
var TZDate = class _TZDate extends TZDateMini {
  ...
  tzComponents() {
    ...
    const hours2 = String(Math.floor(Math.abs(offset4) / 60)).padStart(2, "0");
    const minutes2 = String(Math.abs(offset4) % 60).padStart(2, "0");
    return [
      sign,
      hours2,
      minutes2
...
// node_modules/@vkontakte/vkui/dist/components/Spinner/SpinnerAnimation.js
function SpinnerAnimation({ size: size4 = "m" }) {
...
function iconClassName(size4) {
  return `vkuiIcon vkuiIcon--${size4} vkuiIcon--w-${size4} vkuiIcon--h-${size4}`;
}
...
var Spinner = React41.memo((_param) => {
  var { size: size4 = "m", children = "Загружается...", disableAnimation = false, noColor = false, visibilityDelay } = _param, restProps = _object_without_properties(_param, [
    "size",
    "children",
    "disableAnimation",
    "noColor",
  ...
  const SpinnerIcon = spinnerIconMap[size4];
...
var Button = (_param) => {
  var { size: size4 = "s", mode = "primary", appearance = "accent", stretched = false, align = "center", children, before, after, getRootRef, loading, onClick, disableSpinnerAnimation, rounded, disabled } = _param, restProps = _object_without_properties(_param, [
    "size",
    "mode",
    "appearance",
    "stretched",
  ...
  const { sizeY = "none" } = useAdaptivity();
  const platform3 = usePlatform();
  return (0, import_jsx_runtime34.jsxs)(Tappable, _object_spread_props(_object_spread({
    ...
    baseClassName: clsx("vkuiButton__host", stylesSize[size4], stylesMode[mode], stylesAppearance[appearance], align !== "center" && stylesAlign[align], sizeY !== "compact" && sizeYClassNames10[sizeY], platform3 === "ios" && "vkuiButton__ios", stretched && "vkuiButton__stretched", hasIconOnly && !stretched && "vkuiButton__singleIcon", loading && "vkuiButton__loading", rounded && "vkuiButton__rounded", disabled && "vkuiButton__disabled"),
    getRootRef,
    children: [
...
function getNavId(props, warn24) {
  const id = props.nav || props.id;
  if (!id && warn24) {
    warn24('Навигационный элемент должен иметь свойство "nav" или "id"', "error");
  }
  return id;
}
...
var useFloatingMiddlewaresBootstrap = ({ placement = "bottom-start", arrowRef = null, arrow: arrow4, arrowHeight, arrowPadding, sameWidth, offsetByMainAxis = 0, offsetByCrossAxis = 0, customMiddlewares, hideWhenReferenceHidden, disableFlipMiddleware = false, disableShiftMiddleware = false, flipMiddlewareFallbackAxisSideDirection = "end" }) => {
...
var View = (_param) => {
  ...
  React57.useEffect(() => {
    if (prevActivePanel && prevActivePanel !== activePanelProp && !prevSwipingBack && !prevBrowserSwipe) {
      const firstLayerId = React57.Children.toArray(children).map((panel) => getNavId(panel.props, warn4)).find((id2) => id2 === prevActivePanel || id2 === activePanelProp);
...
function resolveSpacingSize(cssVariable, size4) {
  if (typeof size4 === "string") {
    if (size4.startsWith("--")) {
      return [
        void 0,
        {
          [cssVariable]: `var(${size4})`
        }
      ];
    } else {
      return [
        spacingSizeClassNames[size4],
        void 0
      ];
    }
  }
...
var Separator = (_param) => {
  var { padding = false, appearance = "primary", direction = "horizontal", align = "center", size: size4 } = _param, restProps = _object_without_properties(_param, [
    "padding",
    "appearance",
    "direction",
    "align",
  ...
  const [spacingSizeClassName, spacingSizeStyle] = resolveSpacingSize(CUSTOM_CSS_TOKEN_FOR_USER_SIZE, size4);
  return (0, import_jsx_runtime45.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx(padding && "vkuiSeparator__padded", appearanceClassNames[appearance], directionClassNames[direction], size4 !== void 0 && "vkuiSeparator__sized", align !== "center" && alignClassNames[align], spacingSizeClassName),
...
var Spacing = (_param) => {
  ...
  const [spacingSizeClassName, spacingSizeStyle] = resolveSpacingSize(CUSTOM_CSS_TOKEN_FOR_USER_GAP, size4);
...
var SplitLayout = (_param) => {
  ...
  return (0, import_jsx_runtime50.jsxs)("div", {
    className: clsx("vkuiSplitLayout__host", platform3 === "ios" && "vkuiSplitLayout__ios"),
    ref: getRootRef,
    children: [
      header,
      (0, import_jsx_runtime50.jsxs)("div", _object_spread_props(_object_spread({}, restProps), {
        ref: getRef,
        className: clsx("vkuiSplitLayout__inner", !!header && "vkuiSplitLayout__innerHeader", center && "vkuiSplitLayout__innerCenter", className),
        children: [
          children,
          modal,
          popout
...
var Epic = (_param) => {
  ...
  const story = (_React_Children_toArray_find = React68.Children.toArray(children).find((story2) => React68.isValidElement(story2) && getNavId(story2.props, warn6) === activeStory)) !== null && _React_Children_toArray_find !== void 0 ? _React_Children_toArray_find : null;
...
var TabbarItem = (_param) => {
  ...
  if (true) {
    ...
    if (!hasAccessibleName2) {
      warn7(COMMON_WARNINGS.a11y[Component2 === "a" ? "link-name" : "button-name"], "error");
    }
  }
...
var ScrollArrow = (_param) => {
  var { size: size4 = "m", offsetY, direction, label: labelProp, children = (0, import_jsx_runtime56.jsx)(ArrowIcon, {
    size: size4
  ...
  return (0, import_jsx_runtime56.jsxs)(RootComponent, _object_spread_props(_object_spread({
    Component: "button",
    type: "button",
    baseClassName: clsx("vkuiScrollArrow__host", stylesSize2[size4], stylesDirection2[direction], textDirection === "rtl" && "vkuiScrollArrow__rtl")
  }, restProps), {
    children: [
...
function useAdaptivityHasPointer(deferDetect = true) {
  const { hasPointer: hasPointerContext } = React72.useContext(AdaptivityContext);
...
var HorizontalScroll = (_param) => {
  ...
  const [canScrollStart, setCanScrollStart] = React73.useState(false);
  const [canScrollEnd, setCanScrollEnd] = React73.useState(false);
  const _useFocusVisible = useFocusVisible(), { focusVisible } = _useFocusVisible, focusEvents = _object_without_properties(_useFocusVisible, [
    "focusVisible"
  ]);
  const focusVisibleClassNames = useFocusVisibleClassName({
  ...
  const isCustomScrollingRef = React73.useRef(false);
  const scrollerRef = useExternRef(getRef);
  const animationQueue = React73.useRef([]);
  const hasPointer = useAdaptivityHasPointer();
  const scrollTo = React73.useCallback((getScrollPosition) => {
  ...
  const scrollToStart = React73.useCallback(() => {
  ...
  const scrollToEnd = React73.useCallback(() => {
  ...
  const calculateArrowsVisibility = React73.useCallback(() => {
  ...
  React73.useEffect(calculateArrowsVisibility, [
  ...
  return (0, import_jsx_runtime57.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiHorizontalScroll__host", "vkuiInternalHorizontalScroll", showArrows === "always" && "vkuiHorizontalScroll__withConstArrows", isRtl && "vkuiHorizontalScroll__rtl"),
    onMouseEnter: calculateArrowsVisibility,
    children: [
      showArrows && (hasPointer || hasPointer === void 0) && canScrollStart && (0, import_jsx_runtime57.jsx)(ScrollArrow, {
      ...
      showArrows && (hasPointer || hasPointer === void 0) && canScrollEnd && (0, import_jsx_runtime57.jsx)(ScrollArrow, {
...
var Flex = (_param) => {
  ...
  return (0, import_jsx_runtime60.jsx)(RootComponent, _object_spread_props(_object_spread({}, props), {
    baseClassName: clsx("vkuiFlex__host", !noWrap && "vkuiFlex__wrap", reverse && "vkuiFlex__reverse", direction !== "row" && "vkuiFlex__directionColumn", margin !== "none" && "vkuiFlex__marginAuto", align && alignClassNames2[align], justify && justifyClassNames[justify], getGapsPresets(rowGap, columnGap)),
...
var SimpleGrid = (_param) => {
  ...
  return (0, import_jsx_runtime61.jsx)(RootComponent, _object_spread_props(_object_spread({}, props), {
    baseClassName: clsx("vkuiSimpleGrid__host", margin !== "none" && marginClassNames[margin], alignClassNames3[align], minColWidth && "vkuiSimpleGrid__withMinWidth", typeof columnGap === "string" && columnGapClassNames[columnGap], typeof rowGap === "string" && rowGapClassNames[rowGap]),
    baseStyle: style
  }));
};
...
Используйте CSS Media Query или библиотеку по типу https://github.com/artsy/fresnel.`);
  ...
  const { viewWidth: viewWidthContext, viewHeight: viewHeightContext, sizeX: sizeXContext, sizeY: sizeYContext, hasPointer: hasPointerContext, hasHover: hasHoverContext } = React76.useContext(AdaptivityContext);
  const platform3 = usePlatform();
  const mediaQueries = useMediaQueries();
  const [[viewWidthLocal, viewHeightLocal], setViewSizeLocal] = React76.useState(() => [
  ...
  const adaptivityProps = React76.useMemo(() => {
...
var AlertActions = ({ actions = [], renderAction = (props) => (0, import_jsx_runtime67.jsx)(AlertAction, _object_spread({}, props)), onItemClick, actionsAlign, actionsLayout }) => {
  ...
  return (0, import_jsx_runtime67.jsx)("div", {
    ...
    children: actions.map((action, i) => {
      ...
      return (0, import_jsx_runtime67.jsx)(React80.Fragment, {
...
var AlertBase = (_param) => {
  ...
  const itemActionCallbackRef = React82.useRef(noop);
  ...
  const onItemClick = React82.useCallback((item) => {
...
var Alert = (_param) => {
  ...
  const close = React83.useCallback(() => {
    setClosing(true);
  }, []);
  useScrollLock();
  if (!restProps.title && !restProps["aria-label"] && !restProps["aria-labelledby"]) {
    warn8('Если "title" не используется, то необходимо задать либо "aria-label", либо "aria-labelledby" (см. правило axe aria-dialog-name)');
  }
...
var ActionSheetContext = React84.createContext({});
...
var ActionSheetItem = (_param) => {
  ...
  const platform3 = usePlatform();
  const { onItemClick = () => noop, mode: actionSheetMode, onClose: onActionSheetClose } = React86.useContext(ActionSheetContext);
  ...
  const onItemClickHandler = React86.useCallback((e) => {
    var _onItemClick;
  ...
  const onKeyDown = React86.useCallback((event) => {
  ...
  const onItemClickImpl = React86.useCallback((event) => {
    if (selectable) {
...
function useReferenceHiddenChangeCallback(hideMiddleware, onReferenceHiddenChange) {
  const prevHiddenRef = React88.useRef(hideMiddleware === null || hideMiddleware === void 0 ? void 0 : hideMiddleware.referenceHidden);
  React88.useEffect(() => {
...
var FloatingArrow = (_param) => {
  var { offset: offset4, isStaticOffset, coords, iconStyle, iconClassName: iconClassName2, placement = "bottom", Icon = DefaultIcon } = _param, restProps = _object_without_properties(_param, [
    "offset",
    "isStaticOffset",
    "coords",
    "iconStyle",
...
var Popper = (_param) => {
  ...
  const dropdown = (0, import_jsx_runtime76.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    ...
    children: [
      arrow4 && (0, import_jsx_runtime76.jsx)(FloatingArrow, _object_spread_props(_object_spread({}, arrowProps), {
        coords: arrowCoords,
...
// node_modules/@vkontakte/vkui/dist/components/ActionSheet/ActionSheetDropdownMenu.js
var warn9 = warnOnce("ActionSheet");
function getEl(ref) {
...
var ActionSheetDropdownMenu = (_param) => {
  ...
  const platform3 = usePlatform();
  const { sizeY } = useAdaptivityWithJSMediaQueries();
  const elementRef = React92.useRef(null);
  useEffectDev(() => {
    const toggleEl = getEl(toggleRef);
    if (!toggleEl) {
      warn9(`Свойство "toggleRef" не передано`, "error");
    }
  }, [
    toggleRef
  ]);
  ...
  const targetRef = React92.useMemo(() => {
...
var ActionSheet = (_param) => {
  ...
  const platform3 = usePlatform();
  const [closingBy, setClosingBy] = React94.useState(void 0);
  const onCloseWithOther = React94.useCallback(() => setClosingBy("other"), []);
  const actionCallbackRef = React94.useRef(noop);
  ...
  const onItemClick = React94.useCallback(({ action, immediateAction, autoClose, isCancelItem }) => (event) => {
    event.persist();
...
var ScreenSpinnerContext = React95.createContext({
  state: "loading",
  label: void 0,
  customIcon: void 0
});
...
var ScreenSpinnerLoader = (_param) => {
  ...
  const { label } = React96.useContext(ScreenSpinnerContext);
...
var ScreenSpinnerSwapIcon = (_param) => {
  ...
  const { state, customIcon } = React99.useContext(ScreenSpinnerContext);
  if (state === "cancelable") {
...
var Snackbar = (_param) => {
  var { placement = "bottom-start", children, layout, action, before, after, duration = 4e3, onActionClick, onClose, mode = "default", subtitle, offsetY, getRootRef } = _param, restProps = _object_without_properties(_param, [
    "placement",
    "children",
    "layout",
    "action",
  ...
  const platform3 = usePlatform();
  const [open, setOpen] = React102.useState(true);
  const [touched, setTouched] = React102.useState(false);
  const direction = useConfigDirection();
  const isRtl = direction === "rtl";
  const rootRef = useExternRef(getRootRef);
  const focused = useFocusWithin(rootRef);
  const inRef = React102.useRef(null);
  const panGestureRecognizer = React102.useRef(null);
  const shiftDataRef = React102.useRef(null);
  const rafRef = React102.useRef(null);
  const closeTimeoutIdRef = React102.useRef(void 0);
  const mediaQueries = useMediaQueries();
  const [animationState, animationHandlers] = useCSSKeyframesAnimationController(open ? "enter" : "exit", {
    onExited: onClose
  });
  const clearRAF = React102.useCallback(() => {
    if (rafRef.current !== null) {
      cancelAnimationFrame(rafRef.current);
      rafRef.current = null;
    }
  }, []);
  const updateShiftAxisCSSProperties = React102.useCallback((x, y, direction2) => {
  ...
  const close = React102.useCallback(() => {
    setOpen(false);
  }, []);
  ...
  return (0, import_jsx_runtime87.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    role: "presentation",
    ...
    children: (0, import_jsx_runtime87.jsx)("div", _object_spread_props(_object_spread({
      ...
      children: (0, import_jsx_runtime87.jsx)(Basic, {
        ...
        after,
        subtitle,
        action: action && (0, import_jsx_runtime87.jsx)(Button, {
          align: "left",
          mode: "link",
...
// node_modules/@vkontakte/vkui/dist/hooks/usePatchChildren.js
var warn10 = warnOnce("usePatchChildren");
var usePatchChildren = (children, injectProps, externRef) => {
  ...
  const patchedChildren = isValidElementResult ? React103.cloneElement(children, props) : children;
  useEffectDev(() => {
    if (!childRef.current && !shouldUseRef) {
      warn10("Кажется, в children передан компонент, который не поддерживает свойство getRootRef. Мы не можем получить ссылку на корневой dom-элемент этого компонента", "error");
    }
  }, [
...
var useTooltip = (_param) => {
  ...
  const generatedId = React106.useId();
...
var Tooltip = (_param) => {
  ...
  return (0, import_jsx_runtime91.jsxs)(React107.Fragment, {
    children: [
      anchor,
      tooltip
    ]
...
var ModalRoot = ({ activeModal, children, modalOverlayTestId, noFocusToDialog, disableModalOverlay, usePortal, onOpen, onOpened, onClose, onClosed }) => {
  const contextValue = React108.useMemo(() => ({
    ...
    updateModalHeight: (
      ...
      true ? () => {
        warn11("Метод updateModalHeight() устарел и будет удалён в VKUI v8");
      } : noop
    ),
    // TODO [>=8] Удалить метод
    registerModal: (
      /* istanbul ignore next: deprecated */
      true ? () => {
        warn11("Метод registerModal() устарел и будет удалён в VKUI v8");
      } : noop
    )
  }), [
    activeModal,
  ...
  const modalOverlayRef = React108.useRef(null);
...
function withModalRootContext(Component2) {
  function WithModalRootContext(props) {
    const { updateModalHeight } = React109.useContext(ModalRootContext);
...
// node_modules/@vkontakte/vkui/dist/components/ModalRoot/useModalManager.js
var warn12 = warnOnce("useModalManager");
var useModalManager = ({ id: idProp, open, keepMounted, modalOverlayTestId, noFocusToDialog, disableModalOverlay, onOpen, onOpened, onClose, onClosed }) => {
  ...
  const id = getNavId({
    nav: idProp
  }, context.isInsideModal ? warn12 : void 0) || generatingId;
...
var ModalPage = (_param) => {
  var { id: idProp, nav, open = false, modalOverlayTestId, noFocusToDialog, onOpen, onOpened, onClose, onClosed, size: size4 = "s", settlingHeight = 50, dynamicContentHeight, disableModalOverlay, keepMounted = false } = _param, restProps = _object_without_properties(_param, [
    "id",
    "nav",
    "open",
    "modalOverlayTestId",
...
var ModalCardInternal = (_param) => {
  var { icon, title, titleComponent, description, descriptionComponent, children, actions, size: size4, open, style: styleProp, className, preventClose, ModalOverlay: ModalOverlay2 = ModalOverlay, modalOverlayTestId, modalDismissButtonTestId, getRootRef, dismissButtonMode, dismissLabel, noFocusToDialog, restoreFocus, onOpen, onOpened, onClose = noop, onClosed, disableFocusTrap, disableModalOverlay } = _param, restProps = _object_without_properties(_param, [
    "icon",
    "title",
    "titleComponent",
    "description",
...
var ContentBadgeContext = React113.createContext({
  isSingleChild: false,
  size: "m"
});
...
var ContentBadgeIconSlot = (_param) => {
  ...
  const { size: size4, isSingleChild } = React114.useContext(ContentBadgeContext);
  if (size4 === "s") {
    return null;
  }
...
var ContentBadge = (_param) => {
  var { appearance = "accent", mode = "primary", capsule, size: size4 = "m", weight = "2", children } = _param, restProps = _object_without_properties(_param, [
    "appearance",
    "mode",
    "capsule",
    "size",
  ...
  const { sizeY = "none" } = useAdaptivity();
  const typographyClassNames = size4 === "l" ? footnoteClassNames(sizeY) : captionClassNames(sizeY);
  return (0, import_jsx_runtime109.jsx)(Tappable, _object_spread_props(_object_spread({
    baseClassName: clsx("vkuiContentBadge__host", size4 !== "s" && capsule && "vkuiContentBadge__capsule", mode === "outline" && "vkuiContentBadge__modeOutline", appearanceClassNames2[appearance][mode], sizeClassNames[size4], typographyClassNames, weightClassNames(weight)),
    ...
    children: (0, import_jsx_runtime109.jsx)(ContentBadgeContext.Provider, {
      value: {
        isSingleChild: React115.Children.count(children) === 1,
        size: size4
      },
      children
    })
...
var ButtonGroup = (_param) => {
  ...
  return (0, import_jsx_runtime110.jsx)(RootComponent, _object_spread({
    baseClassName: clsx("vkuiButtonGroup__host", stylesMode5[mode], gap !== "none" && stylesGap[gap], stretched && "vkuiButtonGroup__stretched", stylesAlign2[align]),
    role: "group"
  }, restProps));
};
...
var CardGrid = (_param) => {
  var { size: size4 = "s", padding = false, Component: Component2 = "ul" } = _param, restProps = _object_without_properties(_param, [
    "size",
    "padding",
    "Component"
  ]);
  ...
  return (0, import_jsx_runtime112.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    Component: Component2,
    baseClassName: clsx("vkuiCardGrid__host", "vkuiInternalCardGrid", padding && "vkuiCardGrid__padding", stylesSize3[size4], sizeX !== "regular" && sizeXClassNames5[sizeX])
  }));
};
...
var CardScroll = (_param) => {
  var { children, size: size4 = "s", showArrows = true, padding = false, CardsListComponent = "ul", prevButtonTestId, nextButtonTestId } = _param, restProps = _object_without_properties(_param, [
    "children",
    "size",
    "showArrows",
    "padding",
  ...
  const refContainer = React116.useRef(null);
  const direction = useConfigDirection();
  const { window: window2 } = useDOM();
  ...
  function getScrollToLeft(offset4) {
    ...
    ].findIndex((el) => slideOffsetFromStart(el) + el.offsetWidth + getMarginEnd(el) - offset4 >= 0);
    if (slideIndex === -1) {
      return offset4;
    }
  ...
  function getScrollToRight(offset4) {
    ...
    const slide = Array.prototype.find.call(refContainer.current.children, (el) => {
      return slideOffsetFromStart(el) + el.offsetWidth - offset4 > containerWidth;
    });
    if (!slide) {
      return offset4;
    }
  ...
  return (0, import_jsx_runtime113.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiCardScroll__host", "vkuiInternalCardScroll", size4 !== false && stylesSize4[size4], padding && "vkuiCardScroll__withPaddings"),
...
var Subtitle = ({ subtitleComponent, children, multiline, size: size4 }) => {
  const SubtitleElement = size4 === "m" || size4 === "s" ? Caption : Subhead;
...
var Header = (_param) => {
  var { size: size4 = "m", Component: Component2 = "h2", children, subtitle, subtitleComponent = "span", indicator, after, multiline, before, beforeTitle, afterTitle, beforeSubtitle, afterSubtitle } = _param, restProps = _object_without_properties(_param, [
    "size",
    "Component",
    "children",
    "subtitle",
  ...
  return (0, import_jsx_runtime115.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiHeader__host", sizeClassNames2[size4], isPrimitiveReactNode(indicator) && "vkuiHeader__pi"),
    children: [
...
function useGroupMode(forcedMode, sizeX, isInsideModal) {
  const { layout } = React119.useContext(AppRootContext);
  if (forcedMode) {
    return forcedMode;
  }
  if (isInsideModal) {
...
var GroupContainer = (_param) => {
  ...
  if (isTabPanel && (!restProps["aria-controls"] || !restProps["id"])) {
    warn13('При использовании роли "tabpanel" необходимо задать значение свойств "aria-controls" и "id"');
  }
...
var useDraggableWithDomApi = ({ elRef: draggingElRef, onDragFinish }) => {
  const [dragging, setDragging] = React121.useState(false);
  const lastClientYRef = React121.useRef(0);
  const lastDragShiftYRef = React121.useRef(0);
  const scrollElRef = React121.useRef(null);
  const lastScrollTopRef = React121.useRef(0);
  const scrollControllerRef = React121.useRef(null);
  ...
  const lastDragDirectionRef = React121.useRef(void 0);
  ...
  const itemStartIndexRef = React121.useRef(ITEM_INITIAL_INDEX);
  const itemEndIndexRef = React121.useRef(ITEM_INITIAL_INDEX);
  const draggingItemRef = React121.useRef(null);
  const placeholderItemRef = React121.useRef(null);
  const siblingItemsRef = React121.useRef([]);
  const itemsGapRef = React121.useRef(0);
  ...
  const schedulingAutoScrollTimeoutIdRef = React121.useRef(null);
...
var RemovableIosWithRemove = ({ onRemove, removePlaceholder, removePlaceholderString, children: childrenProp, toggleButtonTestId, removeButtonTestId, disabled }) => {
  ...
  const isRtl = direction === "rtl";
  const { window: window2 } = useDOM();
  const removeButtonRef = React123.useRef(null);
  const disabledRef = React123.useRef(true);
  const [removeOffset, updateRemoveOffset] = React123.useState(0);
...
var Cell = (_param) => {
  ...
  const [dragging, setDragging] = React128.useState(false);
  ...
  const simpleCellProps = _object_spread_props(_object_spread(_object_spread_props(_object_spread({
    ...
    before: (0, import_jsx_runtime129.jsxs)(React128.Fragment, {
      children: [
    ...
    after: (0, import_jsx_runtime129.jsxs)(React128.Fragment, {
      children: [
        draggable && platform3 === "ios" && dragger,
        after
      ]
...
var AvatarBadge = (_param) => {
  ...
  const { size: size4 } = React131.useContext(ImageBaseContext);
  return (0, import_jsx_runtime135.jsx)(ImageBase.Badge, _object_spread_props(_object_spread({}, restProps), {
    className: clsx("vkuiAvatarBadge__host", size4 < 96 && "vkuiAvatarBadge__shifted", className)
  }));
};
...
var AvatarBadgeWithPreset = (_param) => {
  ...
  const direction = useConfigDirection();
  const isRtl = direction === "rtl";
  const { size: size4 } = React133.useContext(ImageBaseContext);
...
var HorizontalCell = (_param) => {
  var { className, title, style, subtitle, size: size4 = "s", children = (0, import_jsx_runtime139.jsx)(Avatar, {
    size: 56
  }), getRootRef, getRef, extraSubtitle, textAlign = size4 === "s" ? "center" : "start", noPadding = false, TitleComponent = size4 === "s" ? Caption : Subhead } = _param, restProps = _object_without_properties(_param, [
    "className",
    "title",
    "style",
    "subtitle",
  ...
  const customProperties = typeof size4 === "number" ? {
    [CUSTOM_CSS_TOKEN_FOR_CELL_WIDTH]: `${size4}px`
  } : void 0;
  return (0, import_jsx_runtime139.jsx)("div", {
    ref: getRootRef,
    style: mergeStyle(customProperties, style),
    className: clsx("vkuiHorizontalCell__host", typeof size4 === "string" && stylesSize5[size4], size4 !== "auto" && "vkuiHorizontalCell__sized", typeof size4 === "number" && "vkuiHorizontalCell__customSize", noPadding && "vkuiHorizontalCell__noPadding", className),
...
var HorizontalCellShowMore = (_param) => {
  var { className, style, getRef, getRootRef, height, size: size4 = "s", children = size4 === "s" ? "Все" : "Показать все", centered = false } = _param, restProps = _object_without_properties(_param, [
    "className",
    "style",
    "getRef",
    "getRootRef",
  ...
  return (0, import_jsx_runtime140.jsx)("div", {
    style,
    className: clsx("vkuiHorizontalCellShowMore__host", centered && "vkuiHorizontalCellShowMore__centered", sizeClassNames3[size4], className),
    ref: getRootRef,
...
var CarouselViewPort = ({ slideTestId, slideWidth, slideLabel = defaultSlideLabel, slideRoleDescription = "Слайд", onChange, onStart, onMoveX, onEnd, getRootRef, layerRef, children, setSlideRef, slidesContainerId }) => {
  const slidesCount = React137.Children.count(children);
  const onSlideFocus = React137.useCallback((e) => onChange === null || onChange === void 0 ? void 0 : onChange(Number(e.currentTarget.dataset.index)), [
    onChange
  ]);
  return (0, import_jsx_runtime144.jsx)(Touch, {
    ...
    children: (0, import_jsx_runtime144.jsx)("div", {
      ...
      children: React137.Children.map(children, (item, i) => (0, import_jsx_runtime144.jsx)("div", {
        role: "group",
...
var ScrollArrows = ({ hasPointer, canSlideLeft, canSlideRight, onSlideRight, onSlideLeft, showArrows = false, arrowSize = "m", arrowAreaHeight = "stretch", arrowPrevLabel, arrowNextLabel, nextArrowTestId, prevArrowTestId, slidesContainerId }) => {
  ...
  return showArrows && hasPointer ? (0, import_jsx_runtime145.jsxs)(import_jsx_runtime145.Fragment, {
    children: [
...
function calculateLoopPoints(indexes, edge, slidesManager, containerWidth, isRtl) {
  ...
  return indexes.map((index2) => {
    ...
    const loopPoint = revertRtlValue2(isStartEdge ? snap + containerWidth + offset4 : snap - slides[index2].width + offset4 - firstSnap, isRtl);
    return {
      index: index2,
...
function getTargetIndex({ slides, slideIndex, currentShiftX, currentShiftXDelta, looped = false, max: max2 = null, isRtl = false }) {
  ...
  const shift4 = revertRtlValue2(currentShiftX + currentShiftXDelta - max2, isRtl);
  ...
  let targetIndex = slides.reduce((val, item, index2) => {
    ...
    const previousValue = Math.abs(previousCoordX + shift4);
    const currentValue = Math.abs(currentCoordX + shift4);
...
function useSlideAnimation() {
  const animationQueue = React139.useRef([]);
...
var CarouselBase = (_param) => {
  ...
  const slidesStore = React140.useRef({});
  const slidesManager = React140.useRef(SLIDES_MANAGER_STATE);
  const textDirection = useConfigDirection();
  const isRtl = textDirection === "rtl";
  const rootRef = useExternRef(getRootRef);
  const viewportRef = useExternRef(getRef);
  const layerRef = React140.useRef(null);
  const animationFrameRef = React140.useRef(null);
  const shiftXCurrentRef = React140.useRef(0);
  const shiftXDeltaRef = React140.useRef(0);
  const initialized = React140.useRef(false);
  const { animationInQueue, addToAnimationQueue, getAnimateFunction, startAnimation } = useSlideAnimation();
  const isDragging = React140.useRef(false);
  const [controlElementsState, setControlElementsState] = React140.useState(CONTROL_ELEMENTS_STATE);
  const hasPointer = useAdaptivityHasPointer();
  const slidesContainerId = React140.useId();
  ...
  const initializeSlides = () => {
    ...
    let localSlides = React140.Children.map(children, (_item, i) => {
    ...
    if (looped) {
      ...
      if (remainingWidth <= 0 && slideIndex2 === localSlides.length) {
        warn14('Ширины слайдов недостаточно для корректной работы свойства "looped". Пожалуйста, сделайте её больше.');
      }
    }
  ...
  return (0, import_jsx_runtime146.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    role: "region",
    onScroll: handleScrollForFixVoiceOverBehavior,
    "aria-roledescription": ariaRoleDescription,
    baseClassName: clsx("vkuiCarouselBase__host", slideWidth === "custom" && "vkuiCarouselBase__customWidth", isDraggable && "vkuiCarouselBase__draggable"),
    getRootRef: rootRef,
    children: [
      ...
      bullets && (0, import_jsx_runtime146.jsx)(Bullets, {
        bullets,
        slideIndex,
        count: React140.Children.count(children),
        bulletTestId
      })
    ]
  }));
...
function useAutoPlay({ timeout, slideIndex, onNext }) {
  const { document: document2 } = useDOM();
  const [paused, setPaused] = React141.useState(false);
  const timeoutRef = React141.useRef(null);
  const callbackFn = useStableCallback(onNext);
  const pause = React141.useCallback(() => setPaused(true), []);
  const resume = React141.useCallback(() => setPaused(false), []);
  const clearAutoPlayTimeout = React141.useCallback(() => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
    }
  }, []);
  const startAutoPlayTimeout = React141.useCallback(() => {
  ...
  React141.useEffect(function initializeAutoPlay() {
    if (!document2 || !timeout || paused) {
      return;
    }
...
var Gallery = (_param) => {
  ...
  const rootRef = useExternRef(getRootRef);
  const [localSlideIndex, setSlideIndex] = React142.useState(initialSlideIndex);
  ...
  const slides = React142.useMemo(() => React142.Children.toArray(children).filter((item) => Boolean(item)), [
    children
  ]);
  const childCount = slides.length;
  const isClient2 = useIsClient();
  const focusWithin = useFocusWithin(rootRef);
  const handleChange = React142.useCallback((current) => {
...
var GridAvatarBadge = (_param) => {
  ...
  const { size: size4 } = React143.useContext(ImageBaseContext);
  return (0, import_jsx_runtime148.jsx)(ImageBase.Badge, _object_spread_props(_object_spread({}, restProps), {
    className: clsx("vkuiGridAvatarBadge__host", size4 < 96 && "vkuiGridAvatarBadge__shifted", className)
  }));
};
...
var warn15 = warnOnce("GridAvatar");
var GridAvatar = (_param) => {
  ...
  if (true) {
    if (src.length > MAX_GRID_LENGTH) {
      warn15(`Длина массива src (${src.length}) больше максимальной (${MAX_GRID_LENGTH})`, "error");
    }
  }
...
var ImageBadge = (_param) => {
  ...
  const { size: size4 } = React144.useContext(ImageBaseContext);
  return (0, import_jsx_runtime150.jsx)(ImageBase.Badge, _object_spread_props(_object_spread({}, restProps), {
    className: clsx("vkuiImageBadge__host", size4 < 96 && "vkuiImageBadge__shifted", className)
  }));
};
...
var Image = (_param) => {
  ...
  const borderStyles = React145.useMemo(() => ({
...
var useBooleanState = (defaultValue = false) => {
  const [value, setValue] = React147.useState(defaultValue);
  const setTrue = React147.useCallback(() => {
    setValue(true);
  }, []);
  const setFalse = React147.useCallback(() => {
    setValue(false);
  }, []);
  const toggle = React147.useCallback(() => {
...
var Search = (_param) => {
  ...
  const generatedId = React148.useId();
  const inputId = idProp ? idProp : `search-${generatedId}`;
  const [hasValue, setHasValue] = React148.useState(() => Boolean(inputProps.value || inputProps.defaultValue));
  ...
  const onCancel = React148.useCallback(() => {
  ...
  const onIconClickStart = React148.useCallback((e) => onIconClick === null || onIconClick === void 0 ? void 0 : onIconClick(e), [
    onIconClick
  ]);
  const onIconCancelClickStart = React148.useCallback((e) => {
      ...
      (0, import_jsx_runtime153.jsxs)("div", {
        ...
        children: [
          ...
          (0, import_jsx_runtime153.jsxs)("div", {
            ...
            children: [
              before,
              (0, import_jsx_runtime153.jsx)(Headline, _object_spread_props(_object_spread({
                Component: "input",
                type: "search",
                level: "1",
                weight: "3"
    ...
    switch (key) {
      ...
      case "Home": {
        ...
        if (key === "Home") {
          ...
          const offset4 = (key === "ArrowRight" ? 1 : -1) * (isRtl ? -1 : 1);
...
var Tabs = (_param) => {
  ...
  const tabsModeContext = React152.useMemo(() => ({
    mode,
    withGaps,
    layoutFillMode,
    withScrollToSelectedTab,
...
var TabsItem = (_param) => {
  ...
  const { sizeY = "none" } = useAdaptivity();
  const { mode, withGaps, layoutFillMode, scrollBehaviorToSelectedTab, withScrollToSelectedTab } = React153.useContext(TabsModeContext);
  const controller = React153.useContext(TabsControllerContext);
  ...
  if (isTabFlow) {
    if (!restProps["aria-controls"]) {
      warn16(`Передайте в "aria-controls" id контролируемого блока`, "warn");
    } else if (!id) {
      warn16(`Передайте "id" компоненту для использования в "aria-labelledby" контролируемого блока`, "warn");
    }
  }
  ...
  const { document: document2 } = useDOM();
  React153.useEffect(function scrollToSelectedItem() {
  ...
  const _onClick = React153.useCallback((e) => {
...
function useStateWithPrev(initialState) {
  return React154.useReducer(reducer, void 0, () => initializer(initialState));
}

// node_modules/@vkontakte/vkui/dist/components/Touch/TouchContext.js
var React155 = __toESM(require_react(), 1);
var TouchRootContext = React155.createContext(false);
...
var PullToRefresh = (_param) => {
  ...
  const scroll = useScroll();
  const { window: window2 } = useDOM();
  const prevIsFetchingRef = React156.useRef(void 0);
  React156.useEffect(() => {
    prevIsFetchingRef.current = isFetching;
  });
  const initParams = React156.useMemo(() => ({
  ...
  const [spinnerY, setSpinnerY] = React156.useState(initParams.start);
  const [watching, setWatching] = React156.useState(false);
  const [refreshing, setRefreshing] = React156.useState(false);
  const [canRefresh, setCanRefresh] = React156.useState(false);
  const [[touchDown, prevTouchDown], setTouchDown] = useStateWithPrev(false);
  const touchY = React156.useRef(0);
  const [contentShift, setContentShift] = React156.useState(0);
  const [spinnerProgress, setSpinnerProgress] = React156.useState(0);
  const resetRefreshingState = React156.useCallback(() => {
    setWatching(false);
    setCanRefresh(false);
    setRefreshing(false);
  ...
  const onRefreshingFinish = React156.useCallback(() => {
    if (!touchDown) {
  ...
  const waitFetchingTimeoutId = React156.useRef(void 0);
  useIsomorphicLayoutEffect(() => {
  ...
  const runRefreshing = React156.useCallback(() => {
  ...
  const startYRef = React156.useRef(0);
  ...
  const iosRefreshStartedRef = React156.useRef(false);
...
var warn17 = warnOnce("OnboardingTooltip");
var OnboardingTooltip = (_param) => {
  ...
  const generatedId = React158.useId();
  const tooltipId = idProp || generatedId;
  const { entering } = useNavTransition();
  const [arrowRef, setArrowRef] = React158.useState(null);
  const [tooltipContainer, setTooltipContainer] = React158.useState(null);
  const [positionStrategy, setPositionStrategy] = React158.useState("absolute");
  ...
  usePlacementChangeCallback(placementProp, resolvedPlacement, onPlacementChange);
  const titleId = React158.useId();
  if (!title && !ariaLabel && !ariaLabelledBy) {
    warn17('Если "title" не используется, то необходимо задать либо "aria-label", либо "aria-labelledby" (см. правило axe aria-dialog-name)');
  }
  let tooltip = null;
  if (shown) {
  ...
  if (true) {
    const multiChildren = React158.Children.count(children) > 1;
    const primitiveChild = hasReactNode(children) && typeof children !== "object";
    (multiChildren || primitiveChild) && warn17([
  ...
  return (0, import_jsx_runtime160.jsxs)(React158.Fragment, {
    children: [
      child,
      tooltip
    ]
...
var Counter = (_param) => {
  var { mode = "inherit", appearance: appearanceProp, color, size: size4 = "m", children, className, style: styleProp } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "appearance",
    "color",
    "size",
  ...
  const appearance = React159.useMemo(() => {
    if (mode === "inherit") {
      return void 0;
    }
    if (appearanceProp) {
  ...
  if (React159.Children.count(children) === 0) {
    return null;
  }
  ...
  return (0, import_jsx_runtime161.jsx)(CounterTypography, _object_spread_props(_object_spread({}, restProps), {
    ...
    Component: "span",
    className: clsx("vkuiInternalCounter", "vkuiCounter__host", modeClassNames2[mode], !!appearance && appearanceClassNames4[appearance], sizeClassNames4[size4], className),
    level: counterLevel,
    children
  }));
};
...
var UsersStack = (_param) => {
  var { photos = [], visibleCount = 3, count = Math.max(0, photos.length - visibleCount), size: size4 = "m", children, avatarsPosition = "inline-start" } = _param, restProps = _object_without_properties(_param, [
    "photos",
    "visibleCount",
    "count",
    "size",
  ...
  return (0, import_jsx_runtime162.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiUsersStack__host", stylesSize6[size4], avatarsPositionStyles[avatarsPosition]),
    children: [
...
var PlaceholderContainer = (_param) => {
  ...
  return (0, import_jsx_runtime163.jsx)(RootComponent, _object_spread({
    baseClassName: clsx("vkuiPlaceholder__host", stretched && "vkuiPlaceholder__stretched", !noPadding && "vkuiPlaceholder__withPadding")
  }, restProps));
};
var PlaceholderIcon = (props) => (0, import_jsx_runtime163.jsx)(RootComponent, _object_spread({
...
var PlaceholderTitle = (_param) => {
  ...
  return (0, import_jsx_runtime163.jsx)(Title, _object_spread({
    level: "2",
    weight: "2",
...
var PlaceholderDescription = (_param) => {
  ...
  return (0, import_jsx_runtime163.jsx)(Headline, _object_spread({
    weight: "3",
    className: clsx(className, "vkuiPlaceholder__description")
  }, restProps));
};
var PlaceholderActions = (props) => (0, import_jsx_runtime163.jsx)(RootComponent, _object_spread({
...
var Placeholder = (_param) => {
  ...
  return (0, import_jsx_runtime163.jsxs)(PlaceholderContainer, _object_spread_props(_object_spread({
    noPadding
  }, restProps), {
    children: [
      hasReactNode(icon) && (0, import_jsx_runtime163.jsx)(PlaceholderIcon, {
        children: icon
      }),
      hasReactNode(title) && (0, import_jsx_runtime163.jsx)(PlaceholderTitle, {
        children: title
      }),
      hasReactNode(children) && (0, import_jsx_runtime163.jsx)(PlaceholderDescription, {
        children
      }),
      hasReactNode(action) && (0, import_jsx_runtime163.jsx)(PlaceholderActions, {
        children: action
      })
    ]
  }));
...
var Banner = (_param) => {
  var { mode = "tint", imageTheme = "dark", size: size4 = "s", before, after: afterProp, title, subtitle, extraSubtitle, children, background, actions, onDismiss, dismissLabel = "Скрыть", Component: Component2 } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "imageTheme",
    "size",
    "before",
  ...
  const SubheadTypography = size4 === "m" ? Text : Subhead;
  const IconDismissIOS = mode === "image" ? Icon24DismissDark : Icon24Dismiss;
  const content = (0, import_jsx_runtime164.jsxs)(import_jsx_runtime164.Fragment, {
    children: [
      mode === "image" && background && (0, import_jsx_runtime164.jsx)("div", {
        "aria-hidden": true,
        className: "vkuiBanner__bg",
        children: background
      }),
      before && (0, import_jsx_runtime164.jsx)("div", {
      ...
      (0, import_jsx_runtime164.jsxs)("div", {
        ...
        children: [
          hasReactNode(title) && (0, import_jsx_runtime164.jsx)(HeaderTypography, {
            Component: "div",
            weight: "2",
            level: size4 === "m" ? "2" : "1",
            children: title
          }),
          hasReactNode(subtitle) && (0, import_jsx_runtime164.jsx)(SubheadTypography, {
            Component: "div",
            className: "vkuiBanner__subtitle",
            children: subtitle
          }),
          hasReactNode(extraSubtitle) && (0, import_jsx_runtime164.jsx)(Text, {
            Component: "div",
            className: "vkuiBanner__extraSubtitle",
            children: extraSubtitle
          }),
          hasReactNode(actions) && React162.Children.count(actions) > 0 && (0, import_jsx_runtime164.jsx)("div", {
  ...
  const afterMap = {
    chevron: (0, import_jsx_runtime164.jsx)(Icon24Chevron, {
      className: "vkuiBanner__chevron"
    }),
    dismiss: (0, import_jsx_runtime164.jsx)(IconButton, {
      label: dismissLabel,
      className: "vkuiBanner__dismiss",
      onClick: onDismiss,
      hoverMode: "opacity",
      hasActive: false,
      children: platform3 === "ios" ? (0, import_jsx_runtime164.jsx)(IconDismissIOS, {}) : (0, import_jsx_runtime164.jsx)(Icon24Cancel, {})
    })
  };
  const after = afterProp && (0, import_jsx_runtime164.jsx)("div", {
  ...
  return (0, import_jsx_runtime164.jsxs)(Tappable, _object_spread_props(_object_spread({
    Component: Component2 || (!isClickable ? "section" : void 0),
    activeMode: platform3 === "ios" ? "opacity" : "background",
    baseClassName: clsx("vkuiBanner__host", platform3 === "ios" && "vkuiBanner__ios", mode === "image" && "vkuiBanner__modeImage", size4 === "m" && "vkuiBanner__sizeM", mode === "image" && imageTheme === "dark" && "vkuiBanner__inverted")
  }, restProps), {
    children: [
      content,
      after
...
var MiniInfoCell = (_param) => {
  ...
  const cellContent = (0, import_jsx_runtime165.jsxs)(React163.Fragment, {
    children: [
      hasReactNode(before) && (0, import_jsx_runtime165.jsx)("span", {
      ...
      (0, import_jsx_runtime165.jsxs)("div", {
        ...
        children: [
          (0, import_jsx_runtime165.jsx)(Paragraph, {
            className: "vkuiMiniInfoCell__content",
            weight: mode === "more" ? "2" : void 0,
            children
          }),
          chevron && (0, import_jsx_runtime165.jsx)(Icon16Chevron, {})
        ]
      }),
      hasReactNode(after) && (0, import_jsx_runtime165.jsx)("span", {
        className: "vkuiMiniInfoCell__after",
        children: after
      })
    ]
  });
  return (0, import_jsx_runtime165.jsx)(Tappable, _object_spread_props(_object_spread({}, restProps), {
...
function useResizeTextarea(onResize, grow) {
  const elementRef = React164.useRef(null);
  const currentScrollHeight = React164.useRef(void 0);
  const resizeElement = React164.useCallback((el) => {
  ...
  const resize = React164.useCallback(() => {
...
var WriteBarTypography = (props) => {
  const platform3 = usePlatform();
  if (platform3 === "ios") {
    return (0, import_jsx_runtime166.jsx)(Title, _object_spread_props(_object_spread({}, props), {
      level: "3",
      weight: "3"
    }));
  }
  return (0, import_jsx_runtime166.jsx)(Headline, _object_spread({
    weight: "3"
  }, props));
};
var WriteBar = (_param) => {
  ...
  React165.useEffect(resize, [
    resize,
    platform3
  ]);
  return (0, import_jsx_runtime166.jsx)("div", {
    ref: getRootRef,
    className: clsx("vkuiWriteBar__host", platform3 === "ios" && "vkuiWriteBar__ios", shadow && "vkuiWriteBar__shadow", className),
    style,
    children: (0, import_jsx_runtime166.jsxs)("div", {
      className: "vkuiWriteBar__form",
      children: [
        hasReactNode(before) && (0, import_jsx_runtime166.jsx)("div", {
        ...
        (0, import_jsx_runtime166.jsxs)("div", {
          ...
          children: [
            (0, import_jsx_runtime166.jsx)(WriteBarTypography, _object_spread_props(_object_spread({}, restProps), {
              Component: "textarea",
              className: "vkuiWriteBar__textarea",
              onChange: callMultiple(onChange, resize),
              getRootRef: textareaRef
            })),
            hasReactNode(inlineAfter) && (0, import_jsx_runtime166.jsx)("div", {
              className: "vkuiWriteBar__inlineAfter",
              children: inlineAfter
            })
          ]
        }),
        hasReactNode(after) && (0, import_jsx_runtime166.jsx)("div", {
...
var warn18 = warnOnce("WriteBarIcon");
var WriteBarIcon = (_param) => {
  ...
  if (true) {
    ...
    if (!isAccessible) {
      warn18(COMMON_WARNINGS.a11y["button-name"], "error");
    }
  }
  return (0, import_jsx_runtime167.jsxs)(Tappable, _object_spread_props(_object_spread({
    Component: "button",
    hasHover: false,
    ...
    children: [
      (0, import_jsx_runtime167.jsxs)("span", {
        className: "vkuiWriteBarIcon__in",
        children: [
          label && (0, import_jsx_runtime167.jsx)(VisuallyHidden, {
            children: label
          }),
          predefinedIcons ? (0, import_jsx_runtime167.jsx)(AdaptiveIconRenderer, _object_spread({}, predefinedIcons)) : children
        ]
      }),
      hasReactNode(count) && (0, import_jsx_runtime167.jsx)(Counter, {
...
var SubnavigationBar = (_param) => {
  ...
  return (0, import_jsx_runtime168.jsx)(RootComponent, _object_spread_props(_object_spread({
    baseClassName: fixed && "vkuiSubnavigationBar__modeFixed"
  }, restProps), {
    children: (0, import_jsx_runtime168.jsx)(ScrollWrapper, _object_spread_props(_object_spread({
      className: "vkuiSubnavigationBar__in"
    }, scrollWrapperProps), {
      children: (0, import_jsx_runtime168.jsx)("ul", {
        className: "vkuiSubnavigationBar__scrollIn",
        children: React167.Children.map(children, (child, idx) => hasReactNode(child) ? (0, import_jsx_runtime168.jsx)("li", {
...
var SubnavigationButtonTypography = (_param) => {
  ...
  if (textLevel === "1") {
    return (0, import_jsx_runtime169.jsx)(Subhead, _object_spread({}, restProps));
  }
  return (0, import_jsx_runtime169.jsx)(Caption, _object_spread({
    level: textLevel === "2" ? "1" : "2"
  }, restProps));
};
var SubnavigationButton = (_param) => {
  var { mode = "primary", appearance = "accent", size: size4 = "m", selected, textLevel = "1", before, after, chevron, children } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "appearance",
    "size",
    "selected",
  ...
  const { sizeY = "none" } = useAdaptivity();
  return (0, import_jsx_runtime169.jsx)(Tappable, _object_spread_props(_object_spread({
    hasActive: false,
    focusVisibleMode: "outside"
  }, restProps), {
    baseClassName: clsx("vkuiSubnavigationButton__host", sizeStyles[size4], modeStyles2[mode], appearanceStyles[appearance], selected && "vkuiSubnavigationButton__selected", sizeY !== "regular" && sizeYClassNames19[sizeY], restProps.disabled && "vkuiSubnavigationButton__disabled"),
    children: (0, import_jsx_runtime169.jsxs)("span", {
      className: "vkuiSubnavigationButton__in",
      children: [
        before && (0, import_jsx_runtime169.jsx)("span", {
          className: "vkuiSubnavigationButton__before",
          children: before
        }),
        (0, import_jsx_runtime169.jsx)(SubnavigationButtonTypography, {
          textLevel,
          className: "vkuiSubnavigationButton__label",
          Component: "span",
          children
        }),
        after && (0, import_jsx_runtime169.jsx)("span", {
          className: "vkuiSubnavigationButton__after",
          children: after
        }),
        chevron && (0, import_jsx_runtime169.jsx)(Icon16Dropdown, {
...
var usePagination = ({ currentPage = 1, siblingCount = 1, boundaryCount = 1, totalPages: endPage = 1 } = {}) => React169.useMemo(() => {
...
var getButtonPropsFromPaginationNavigationButton = (opts) => {
  const icon = opts.style !== "caption" ? (0, import_jsx_runtime170.jsxs)(import_jsx_runtime170.Fragment, {
    children: [
      (0, import_jsx_runtime170.jsx)(VisuallyHidden, {
        children: opts.a11yLabel
      }),
      (0, import_jsx_runtime170.jsx)(opts.Icon, {})
    ]
  }) : null;
  const caption = opts.style === "caption" ? (0, import_jsx_runtime170.jsxs)(import_jsx_runtime170.Fragment, {
    children: [
      (0, import_jsx_runtime170.jsx)(VisuallyHidden, {
        children: opts.a11yLabel
      }),
  ...
  }) : opts.style !== "icon" ? (0, import_jsx_runtime170.jsx)("span", {
    "aria-hidden": "true",
    children: opts.caption
  }) : null;
  return {
...
var PaginationNavigationButton = (_param) => {
  ...
  return (0, import_jsx_runtime170.jsx)(Button, _object_spread({}, buttonProps));
};
...
var getTappablePropsFromPaginationPage = (opts) => {
  ...
  return _object_spread({
    ...
    "disabled": disabled,
    "children": (0, import_jsx_runtime171.jsxs)(Text, {
      normalize: false,
      children: [
        pageLabel && (0, import_jsx_runtime171.jsxs)(VisuallyHidden, {
          children: [
            pageLabel,
            " "
          ]
...
var PaginationPageButton = (_param) => {
  ...
  return (0, import_jsx_runtime171.jsx)(Tappable, _object_spread({}, tappableProps));
};
...
var PaginationPageEllipsis = (_param) => {
  ...
  return (0, import_jsx_runtime172.jsx)(Text, _object_spread_props(_object_spread({
...
var Pagination = (_param) => {
  ...
  const handlePrevClick = React173.useCallback((event) => {
  ...
  const { sizeY } = useAdaptivity();
  const renderPages = React173.useCallback((page) => {
    const isCurrent = page === currentPage;
    const dataTestId = pageButtonTestId === null || pageButtonTestId === void 0 ? void 0 : pageButtonTestId(page, isCurrent);
    switch (page) {
      case "start-ellipsis":
      case "end-ellipsis":
        return (0, import_jsx_runtime173.jsx)("li", {
          children: (0, import_jsx_runtime173.jsx)(PaginationPageEllipsis, {
            disabled,
      ...
      default: {
        return (0, import_jsx_runtime173.jsx)("li", {
          children: (0, import_jsx_runtime173.jsx)(PaginationPageButton, {
            getPageLabel,
            isCurrent,
            onClick: handleClick,
            disabled,
  ...
  const navigationLabelId = React173.useId();
  return (0, import_jsx_runtime173.jsxs)(RootComponent, _object_spread_props(_object_spread({
    Component: "nav",
    role: "navigation",
    "aria-labelledby": navigationLabelId
  }, resetProps2), {
    children: [
      (0, import_jsx_runtime173.jsx)(VisuallyHidden, {
        id: navigationLabelId,
        Component: navigationLabelComponent,
        children: navigationLabel
      }),
      (0, import_jsx_runtime173.jsxs)("ul", {
        className: "vkuiPagination__list",
        children: [
          (0, import_jsx_runtime173.jsx)("li", {
            className: "vkuiPagination__prevButtonContainer",
            children: (0, import_jsx_runtime173.jsx)(PaginationNavigationButton, {
              type: "prev",
...
var AccordionContext = React174.createContext({
  labelId: "",
  contentId: "",
  expanded: false,
...
var AccordionContent = (_param) => {
  ...
  const { expanded, labelId, contentId, unmountOnCollapsed } = React175.useContext(AccordionContext);
  ...
  return (0, import_jsx_runtime174.jsx)("div", _object_spread_props(_object_spread({
    ref: getRootRef,
    id: contentId,
    role: "region",
    ...
    children: (0, import_jsx_runtime174.jsx)("div", _object_spread_props(_object_spread({
      ref: inRef,
...
var AccordionSummary = (_param) => {
  ...
  const { expanded, labelId, contentId, onChange } = React176.useContext(AccordionContext);
  ...
  const icon = (
    ...
    (0, import_jsx_runtime175.jsx)("span", {
      className: "vkuiIcon",
      children: (0, import_jsx_runtime175.jsx)(Icon, {
        className: "vkuiAccordion__icon"
      })
    })
  );
  const toggle = () => onChange(!expanded);
  return (0, import_jsx_runtime175.jsx)(SimpleCell, _object_spread_props(_object_spread({
    id: labelId,
    "aria-expanded": expanded,
    "aria-controls": contentId,
    onClick: callMultiple(toggle, onClick),
    before: (0, import_jsx_runtime175.jsxs)(import_jsx_runtime175.Fragment, {
      children: [
        iconPosition === "before" && icon,
        before
      ]
    }),
    after: (0, import_jsx_runtime175.jsxs)(import_jsx_runtime175.Fragment, {
      children: [
        after,
...
function useAccordionId(id) {
  const generatedId = React177.useId();
...
var Accordion = (_param) => {
  ...
  return (0, import_jsx_runtime176.jsx)(AccordionContext.Provider, {
    value: context,
    children
  });
};
...
var FormItemTop = (props) => (0, import_jsx_runtime177.jsx)(RootComponent, _object_spread_props(_object_spread({}, props), {
...
var FormItemTopAside = (_param) => {
  ...
  return (0, import_jsx_runtime178.jsx)(Subhead, _object_spread_props(_object_spread({
...
var FormItemContext = React179.createContext({
  required: false,
  topMultiline: false
});
...
var FormItemTopLabel = (_param) => {
  ...
  const { required, topMultiline } = React180.useContext(FormItemContext);
  return (0, import_jsx_runtime179.jsxs)(Subhead, _object_spread_props(_object_spread({
    ...
    children: [
      children,
      required && (0, import_jsx_runtime179.jsx)("span", {
...
var FormItem = (_param) => {
  ...
  const { sizeY = "none" } = useAdaptivity();
  const wrappedChildren = (0, import_jsx_runtime180.jsxs)(React181.Fragment, {
    children: [
      isPrimitiveReactNode(top) ? (0, import_jsx_runtime180.jsx)(FormItemTop, {
        children: (0, import_jsx_runtime180.jsx)(FormItemTopLabel, {
          htmlFor,
      ...
      children,
      hasReactNode(bottom) && (0, import_jsx_runtime180.jsx)(Footnote, {
  ...
  const context = React181.useMemo(() => ({
    required,
    topMultiline
  }), [
    required,
  ...
  return (0, import_jsx_runtime180.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    getRootRef: rootEl,
    ...
    children: (0, import_jsx_runtime180.jsx)(FormItemContext.Provider, {
      value: context,
      children: removable ? (0, import_jsx_runtime180.jsx)(Removable, {
        align: "start",
        onRemove: (e) => {
...
var renderIcon = (icon, align, className) => {
  return (0, import_jsx_runtime181.jsx)("div", {
    className: "vkuiFormField__iconWrapper",
    children: (0, import_jsx_runtime181.jsx)("span", {
...
var FormField = (_param) => {
  ...
  const { sizeY = "none" } = useAdaptivity();
  const [hover, setHover] = React182.useState(false);
  ...
  return (0, import_jsx_runtime181.jsxs)(Component2, _object_spread_props(_object_spread({}, restProps), {
    ref: elRef,
    style: _object_spread({
      maxHeight
    }, style),
    ...
    children: [
      (0, import_jsx_runtime181.jsxs)("div", {
      ...
      (0, import_jsx_runtime181.jsx)("span", {
        "aria-hidden": true,
...
var FormLayoutGroup = (_param) => {
  ...
  const rootEl = useExternRef(getRootRef);
  return (0, import_jsx_runtime182.jsx)(RootComponent, _object_spread_props(_object_spread({
    getRootRef: rootEl,
    Component: "fieldset",
    ...
    children: isRemovable ? (0, import_jsx_runtime182.jsx)(Removable, {
      ...
      indent: removable === "indent",
      children
    }) : (0, import_jsx_runtime182.jsxs)(React183.Fragment, {
      children: [
        children,
...
var FormStatus = (_param) => {
  ...
  return (0, import_jsx_runtime183.jsx)(Banner, _object_spread_props(_object_spread({}, restProps), {
    title,
    role,
    subtitle: children,
...
var Switch = (_param) => {
  ...
  const [localUncontrolledChecked, setLocalUncontrolledChecked] = React185.useState(Boolean(restProps.defaultChecked));
  const isControlled = checkedProp !== void 0;
  const syncUncontrolledCheckedStateOnClick = React185.useCallback((e) => {
    if (isControlled) {
      return;
    }
  ...
  return (0, import_jsx_runtime184.jsxs)("label", {
    className: clsx("vkuiSwitch__host", sizeY !== "regular" && sizeYClassNames23[sizeY], platform3 === "ios" ? "vkuiSwitch__ios" : "vkuiSwitch__default", disabled && "vkuiSwitch__disabled", isRtl && "vkuiSwitch__rtl", focusVisibleClassNames, className),
    style,
    ref: getRootRef,
    children: [
      (0, import_jsx_runtime184.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, inputProps), {
        className: "vkuiSwitch__inputNative",
        onBlur: handleBlur,
        onFocus: handleFocus
      })),
      (0, import_jsx_runtime184.jsxs)("span", {
        "aria-hidden": true,
        ...
        children: [
          ...
          (0, import_jsx_runtime184.jsx)("span", {
            "aria-hidden": true,
            className: clsx("vkuiSwitch__handle", platform3 !== "ios" && !disabled && "vkuiSwitch__handleWithRipple")
          })
        ]
      })
    ]
...
var File = (_param) => {
  ...
  return (0, import_jsx_runtime185.jsxs)(Button, {
    Component: "label",
    align,
    className,
    stretched,
    ...
    disabled: restProps.disabled,
    children: [
      (0, import_jsx_runtime185.jsx)(VisuallyHidden, _object_spread_props(_object_spread({
        title: ""
      }, restProps), {
        Component: "input",
        type: "file",
...
var DropZoneGrid = (_param) => {
  ...
  return (0, import_jsx_runtime186.jsx)(RootComponent, _object_spread({
...
var DropZone = (_param) => {
  ...
  return (0, import_jsx_runtime187.jsx)(RootComponent, _object_spread_props(_object_spread({
...
var Input = (_param) => {
  ...
  const { sizeY = "none" } = useAdaptivity();
  return (0, import_jsx_runtime188.jsx)(FormField, {
    style,
    ...
    mode,
    status,
    children: (0, import_jsx_runtime188.jsx)(UnstyledTextField, _object_spread_props(_object_spread({}, restProps), {
      as: "input",
      type,
...
var Chip = (_param) => {
  ...
  const onRemoveWrapper = React189.useCallback((event) => {
    onRemove === null || onRemove === void 0 ? void 0 : onRemove(event, value);
  }, [
    onRemove,
    value
  ]);
  return (0, import_jsx_runtime189.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    Component: Component2,
    ...
    children: [
      (0, import_jsx_runtime189.jsxs)("div", {
        className: "vkuiChip__in",
        children: [
          hasReactNode(before) && (0, import_jsx_runtime189.jsx)("div", {
            className: "vkuiChip__before",
            children: before
          }),
          (0, import_jsx_runtime189.jsx)(Footnote, {
            className: "vkuiChip__content",
            children
          }),
          hasReactNode(after) && (0, import_jsx_runtime189.jsx)("div", {
            className: "vkuiChip__after",
            children: after
          })
        ]
      }),
      !readOnly && removable && (0, import_jsx_runtime189.jsx)("div", {
        className: "vkuiChip__removable",
        children: (0, import_jsx_runtime189.jsxs)("button", {
          type: "button",
          tabIndex: -1,
          disabled,
          ...
          children: [
            (0, import_jsx_runtime189.jsxs)(VisuallyHidden, {
              children: [
                "  ",
                removeLabel,
                " ",
            ...
            (0, import_jsx_runtime189.jsx)(Icon16Cancel, {})
          ]
        })
      })
    ]
...
var FormFieldClearButton = (_param) => {
  ...
  return (0, import_jsx_runtime190.jsx)(IconButton, _object_spread_props(_object_spread({
    Component: "button",
    label: "Очистить поле",
    ...
    children: (0, import_jsx_runtime190.jsx)(Icon16Cancel, {})
  }));
};
...
function renderChipDefault(props) {
  ...
  return (0, import_jsx_runtime191.jsx)(Chip, _object_spread_props(_object_spread({
...
var ChipsInputBase = (_param) => {
  ...
  const { sizeY = "none" } = useAdaptivity();
  const idGenerated = React192.useId();
  const inputRef = useExternRef(getRef);
  const containerRef = React192.useRef(null);
  const listboxRef = React192.useRef(null);
  const valueLength = value.length;
  const withPlaceholder = valueLength === 0;
  const [lastFocusedChipOptionIndex, setLastFocusedChipOptionIndex] = React192.useState(0);
  ...
  const handleClear = React192.useCallback(() => {
    if (inputRef.current) {
      resetChipOptionFocusToInputEl(inputRef.current);
    }
    onClear();
  ...
  const clearButton = React192.useMemo(() => {
    if (clearButtonShown) {
      return (0, import_jsx_runtime192.jsx)(ClearButton, {
        onClick: handleClear,
        disabled,
        "data-testid": clearButtonTestId
      });
  ...
  const afterItems = React192.useMemo(() => {
    if (clearButton || after) {
      return (0, import_jsx_runtime192.jsxs)(import_jsx_runtime192.Fragment, {
        children: [
          clearButton,
          after
        ]
  ...
  return (0, import_jsx_runtime192.jsx)(FormField, {
    Component: "div",
    getRootRef,
    ...
    children: (0, import_jsx_runtime192.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime192.jsx)("div", {
          ...
          children: value.map((option, index2) => (0, import_jsx_runtime192.jsx)(React192.Fragment, {
            children: renderChip({
              "Component": "div",
              "value": option.value,
              "label": option.label,
        ...
        (0, import_jsx_runtime192.jsx)(Text, _object_spread_props(_object_spread({
          autoCapitalize: "none",
          autoComplete: "off",
          autoCorrect: "off",
          spellCheck: false
...
var useChipsInput = ({
  ...
  const inputRef = React193.useRef(null);
  ...
  const toggleOption = React193.useCallback((nextValuesProp, isNewValue) => {
    setValue((prevValue) => {
  ...
  const clearInput = React193.useCallback(() => {
    if (!inputRef.current) {
      return;
    }
  ...
  const addOption = React193.useCallback((newValue) => toggleOption([
    newValue
  ], true), [
    toggleOption
  ]);
  const addOptions = React193.useCallback((newValues) => toggleOption(newValues, true), [
    toggleOption
  ]);
  const removeOption = React193.useCallback((newValue) => toggleOption([
    newValue
  ], false), [
    toggleOption
  ]);
  const addOptionFromInput = React193.useCallback((inputValue2) => {
  ...
  const reset = React193.useCallback(() => {
    setValue(defaultValue);
  }, [
    defaultValue,
    setValue
  ]);
  const clearOptions = React193.useCallback(() => {
  ...
  const onInputChange = React193.useCallback((e, canCreate = true) => {
...
var ChipsInput = (_param) => {
  ...
  return (0, import_jsx_runtime193.jsx)(ChipsInputBase, _object_spread_props(_object_spread({}, restProps), {
    disabled,
    value,
...
var CustomSelectDropdown = (_param) => {
  ...
  return (0, import_jsx_runtime194.jsx)(Popper, _object_spread_props(_object_spread({
    targetRef,
    ...
    children: (0, import_jsx_runtime194.jsx)(CustomScrollView, {
      getRootRef: scrollBoxRef,
      className: noMaxHeight ? void 0 : "vkuiCustomSelectDropdown__inWithMaxHeight",
      overscrollBehavior,
      tabIndex: -1,
      "aria-busy": fetching,
      children: fetching ? (0, import_jsx_runtime194.jsx)("div", {
        className: "vkuiCustomSelectDropdown__fetching",
        children: (0, import_jsx_runtime194.jsx)(Spinner, {
          size: "s"
        })
      }) : children
    })
...
var CustomSelectOption = (_param) => {
  ...
  const { sizeY = "none" } = useAdaptivity();
  const style = React195.useMemo(() => hierarchy > 0 ? {
    "--vkui_internal--custom_select_option_hierarchy_level": hierarchy
  } : void 0, [
    hierarchy
  ]);
  const hovered = hoveredProp && !disabled ? true : false;
  return (0, import_jsx_runtime195.jsxs)(Paragraph, _object_spread_props(_object_spread({}, restProps), {
    ...
    style: mergeStyle(style, styleProp),
    children: [
      hasReactNode(before) && (0, import_jsx_runtime195.jsx)("div", {
        className: "vkuiCustomSelectOption__before",
        children: before
      }),
      (0, import_jsx_runtime195.jsxs)("div", {
        className: "vkuiCustomSelectOption__main",
        children: [
          (0, import_jsx_runtime195.jsx)("div", {
            className: "vkuiCustomSelectOption__children",
            children
          }),
          hasReactNode(description) && (0, import_jsx_runtime195.jsxs)(Footnote, {
            className: "vkuiCustomSelectOption__description",
            children: [
              (0, import_jsx_runtime195.jsx)(VisuallyHidden, {
                children: " "
              }),
              description
            ]
      ...
      (0, import_jsx_runtime195.jsxs)("div", {
        ...
        children: [
          hasReactNode(after) && (0, import_jsx_runtime195.jsx)("div", {
            children: after
          }),
          selected && (0, import_jsx_runtime195.jsx)(Icon16Done, {
...
var DropdownIcon = (_param) => {
  ...
  return (0, import_jsx_runtime196.jsxs)(React196.Fragment, {
    children: [
      sizeY.compact && (0, import_jsx_runtime196.jsx)(IconCompact, _object_spread({
        className: clsx(sizeY.compact.className, className)
      }, restProps)),
      sizeY.regular && (0, import_jsx_runtime196.jsx)(IconRegular, _object_spread({
...
var renderOptionDefault = (props) => (0, import_jsx_runtime197.jsx)(CustomSelectOption, _object_spread({}, props));
...
var useChipsSelect = ({
  ...
  const [opened, setOpened] = React197.useState(false);
  const [options, setOptions] = React197.useState(() => opened ? transformOptions({
    value,
    getOptionValue,
    getOptionLabel,
    inputValue,
  ...
  const [focusedOptionIndex, setFocusedOptionIndex] = React197.useState(0);
  const [focusedOption, setFocusedOption] = React197.useState(null);
  const handleOpened = React197.useCallback((isOpened) => {
  ...
  const handleInputChange = React197.useCallback((event) => {
...
var ChipsSelect = (_param) => {
  ...
  const rootRef = useExternRef(getRootRef);
  const inputRef = useExternRef(getRef, inputRefHook);
  const [dropdownVerticalPlacement, setDropdownVerticalPlacement] = React198.useState(placementProp);
  const onDropdownPlacementChange = React198.useCallback((placement) => {
    if (placement.startsWith("top")) {
  ...
  const chipsSelectOptions = React198.useRef([]).current;
  ...
  const onDropdownMouseLeave = React198.useCallback(() => {
    setFocusedOptionIndex(null);
  }, [
    setFocusedOptionIndex
  ]);
  const handleClickOutside = React198.useCallback(() => {
    setOpened(false);
  }, [
    setOpened
  ]);
  useGlobalOnEventOutside("mousedown", handleClickOutside, opened ? rootRef : null, opened ? dropdownScrollBoxRef : null);
  const onDropdownIconClick = React198.useCallback((e) => {
    e.preventDefault();
    setOpened(!opened);
  }, [
    opened,
  ...
  const dropdownContent = React198.useMemo(() => {
    const defaultDropdownContent = options.map((option, index2) => {
      ...
      return (0, import_jsx_runtime198.jsx)(React198.Fragment, {
  ...
  const openedClassNames = React198.useMemo(() => opened && dropdownOffsetDistance === 0 && (dropdownVerticalPlacement.includes("top") ? "vkuiChipsSelect__popUp" : "vkuiChipsSelect__popDown") || void 0, [
    dropdownOffsetDistance,
    opened,
    dropdownVerticalPlacement
  ]);
  const clearButtonShown = allowClearButton && (!!value.length || !!inputValue.length);
  return (0, import_jsx_runtime198.jsxs)(import_jsx_runtime198.Fragment, {
    children: [
      (0, import_jsx_runtime198.jsx)(ChipsInputBase, _object_spread_props(_object_spread({}, restProps), {
        disabled,
        readOnly,
        clearButtonShown,
        clearButtonTestId,
        ...
        status,
        after: dropdownIconProp || (0, import_jsx_runtime198.jsx)(DropdownIcon, {
          opened,
      ...
      opened && (0, import_jsx_runtime198.jsx)(CustomSelectDropdown, {
...
var SliderThumb = (_param) => {
  ...
  const [arrowRef, setArrowRef] = React199.useState(null);
  const memoizedMiddlewares = React199.useMemo(() => {
    return [
      offset3({
        crossAxis: 0,
        mainAxis: 15
  ...
  React199.useEffect(function udpateTooltipPositionOnValueChange() {
  ...
  return (0, import_jsx_runtime199.jsxs)(React199.Fragment, {
    children: [
      (0, import_jsx_runtime199.jsx)("span", _object_spread_props(_object_spread({}, restProps), {
        ref: handleRootRef,
        ...
        children: (0, import_jsx_runtime199.jsx)("input", _object_spread_props(_object_spread({}, inputProps), {
          type: "range",
      ...
      shouldShowTooltip && (0, import_jsx_runtime199.jsx)(TooltipBase, {
        appearance: "neutral",
...
var Slider = (_param) => {
  var { step = 1, min: min2 = 0, max: max2 = 100, value: valueProp, multiple: multipleProp, defaultValue = multipleProp ? [
    min2,
    max2
  ] : min2, disabled, className, getRootRef, getAriaLabel, getAriaValueText, startThumbTestId, endThumbTestId, onChange, withTooltip, size: size4 = "l", style: styleProp } = _param, restProps = _object_without_properties(_param, [
    "step",
    "min",
    "max",
    "value",
  ...
  const [localValue, setValue] = React200.useState(defaultValue);
  ...
  const [activeThumb, setActiveThumb] = React200.useState(null);
  const gesture = React200.useRef({
    dragging: null,
    startX: 0,
    containerWidth: 0
  }).current;
  const thumbsContainerRef = useExternRef(getRootRef);
  const thumbStartInputRef = React200.useRef(null);
  const thumbEndInputRef = React200.useRef(null);
  ...
  return (0, import_jsx_runtime200.jsxs)(Touch, _object_spread_props(_object_spread({
    "data-value": multiple ? `${startValue},${endValue}` : startValue
  }, restPropsWithoutAriaAttributes), {
    className: clsx("vkuiSlider__host", disabled && "vkuiSlider__disabled", sizeY !== "regular" && sizeYClassNames28[sizeY], sizeClassNames5[size4], multiple && "vkuiSlider__multiple", isRtl && "vkuiSlider__rtl", className),
    ...
    children: [
      ...
      (0, import_jsx_runtime200.jsxs)("div", {
        ref: thumbsContainerRef,
        className: "vkuiSlider__thumbs",
        children: [
          (0, import_jsx_runtime200.jsx)(SliderThumb, {
            "data-type": "start",
          ...
          multiple && (0, import_jsx_runtime200.jsx)(SliderThumb, {
            "data-type": "end",
...
var Textarea = (_param) => {
  ...
  return (0, import_jsx_runtime201.jsx)(FormField, {
    ...
    beforeAlign,
    maxHeight,
    children: (0, import_jsx_runtime201.jsx)(UnstyledTextField, _object_spread_props(_object_spread({}, restProps), {
      value,
      as: "textarea",
      rows,
...
function SelectionControlLabel(_param) {
  ...
  const { sizeY = "none" } = useAdaptivity();
  return (0, import_jsx_runtime202.jsxs)(RootComponent, _object_spread_props(_object_spread({
    ...
    children: [
      (0, import_jsx_runtime202.jsxs)("div", {
        className: "vkuiSelectionControlLabel__titleLayout",
        children: [
          (0, import_jsx_runtime202.jsx)(Text, {
      ...
      hasReactNode(description) && (0, import_jsx_runtime202.jsx)(Footnote, {
...
var SelectionControl = (_param) => {
  ...
  return (0, import_jsx_runtime203.jsx)(SelectionControlContext.Provider, {
    value: {
      noPadding
    },
    children: (0, import_jsx_runtime203.jsx)(Tappable, _object_spread({
      Component: "label",
...
function RadioIcon24(props) {
  return (0, import_jsx_runtime204.jsxs)("svg", _object_spread_props(_object_spread({
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
    "aria-hidden": true
    ...
    children: [
      (0, import_jsx_runtime204.jsx)("circle", {
        cx: "12",
        cy: "12",
        r: "10",
        stroke: "currentColor",
...
function RadioIcon() {
  return (0, import_jsx_runtime204.jsx)("div", {
    className: "vkuiRadioInput__icon",
    children: (0, import_jsx_runtime204.jsx)(AdaptiveIconRenderer, {
...
function RadioInput(_param) {
  ...
  return (0, import_jsx_runtime204.jsxs)(RootComponent, {
    className,
    style,
    getRootRef,
    children: [
      (0, import_jsx_runtime204.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, restProps), {
        Component: "input",
        type: "radio",
        baseClassName: "vkuiRadioInput__input",
        getRootRef: getRef
      })),
      (0, import_jsx_runtime204.jsx)(RadioIcon, {})
    ]
  });
}
...
var Radio2 = (_param) => {
  ...
  return (0, import_jsx_runtime205.jsxs)(SelectionControl, _object_spread_props(_object_spread({
    style,
    ...
    children: [
      (0, import_jsx_runtime205.jsx)(RadioInput, _object_spread_props(_object_spread({}, restProps), {
        getRef
      })),
      (0, import_jsx_runtime205.jsx)(SelectionControlLabel, {
        titleAfter,
        description,
        children
      })
...
var RadioGroup = (_param) => {
  ...
  return (0, import_jsx_runtime206.jsx)(RootComponent, _object_spread({
...
function CheckboxInput(_param) {
  ...
  const handleChange = React206.useCallback((event) => {
  ...
  if (true) {
    if (defaultIndeterminate && restProps.defaultChecked) {
      warn19("defaultIndeterminate и defaultChecked не могут быть true одновременно", "error");
    }
    if (indeterminate && restProps.checked) {
      warn19("indeterminate и checked не могут быть true одновременно", "error");
    }
    if (restProps.defaultChecked && restProps.checked) {
      warn19("defaultChecked и checked не могут быть true одновременно", "error");
    }
  }
  return (0, import_jsx_runtime207.jsxs)(RootComponent, {
    baseClassName: "vkuiCheckboxInput__host",
    className,
    style,
    getRootRef,
    children: [
      (0, import_jsx_runtime207.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, restProps), {
        Component: "input",
        type: "checkbox",
        onChange: handleChange,
      ...
      platform3 === "vkcom" ? (0, import_jsx_runtime207.jsx)(IconOnCompact, {
        className: "vkuiCheckboxInput__iconOn"
      }) : (0, import_jsx_runtime207.jsxs)(React206.Fragment, {
        children: [
          adaptiveSizeY.compact && (0, import_jsx_runtime207.jsx)(IconOnCompact, {
            className: clsx("vkuiCheckboxInput__iconOn", adaptiveSizeY.compact.className)
          }),
          adaptiveSizeY.regular && (0, import_jsx_runtime207.jsx)(IconOnRegular, {
            className: clsx("vkuiCheckboxInput__iconOn", adaptiveSizeY.regular.className)
          })
        ]
      }),
      platform3 === "vkcom" ? (0, import_jsx_runtime207.jsx)(IconOffCompact, {
        className: "vkuiCheckboxInput__iconOff"
      }) : (0, import_jsx_runtime207.jsxs)(React206.Fragment, {
        children: [
          adaptiveSizeY.compact && (0, import_jsx_runtime207.jsx)(IconOffCompact, {
            className: clsx("vkuiCheckboxInput__iconOff", adaptiveSizeY.compact.className)
          }),
          adaptiveSizeY.regular && (0, import_jsx_runtime207.jsx)(IconOffRegular, {
            className: clsx("vkuiCheckboxInput__iconOff", adaptiveSizeY.regular.className)
          })
        ]
      }),
      platform3 === "vkcom" ? (0, import_jsx_runtime207.jsx)(IconIndeterminate, {
        width: 20,
        height: 20,
        className: "vkuiCheckboxInput__iconIndeterminate"
      }) : (0, import_jsx_runtime207.jsxs)(React206.Fragment, {
        children: [
          adaptiveSizeY.compact && (0, import_jsx_runtime207.jsx)(IconIndeterminate, {
            className: clsx("vkuiCheckboxInput__iconIndeterminate", adaptiveSizeY.compact.className),
            width: 20,
            height: 20
          }),
          adaptiveSizeY.regular && (0, import_jsx_runtime207.jsx)(IconIndeterminate, {
...
function CheckboxSimple(_param) {
  var { children, className, style, getRootRef, description, hoverMode: hoverModeProp, activeMode: activeModeProp, hasHover: hasHover2, hasActive, focusVisibleMode, titleAfter, noPadding } = _param, restProps = _object_without_properties(_param, [
    "children",
    "className",
    "style",
    "getRootRef",
  ...
  const hoverMode = hoverModeProp || (noPadding ? "opacity" : "background");
  const activeMode = activeModeProp || (noPadding ? "opacity" : "background");
  return (0, import_jsx_runtime208.jsx)(Tappable, {
    className: clsx(className, "vkuiCheckboxSimple__host", !noPadding && "vkuiCheckboxSimple__withPadding", sizeY !== "regular" && sizeYClassNames32[sizeY]),
    style,
    disabled: restProps.disabled,
    getRootRef,
    hoverMode,
    ...
    focusVisibleMode,
    Component: "label",
    children: (0, import_jsx_runtime208.jsx)(CheckboxInput, _object_spread({}, restProps))
  });
}

// node_modules/@vkontakte/vkui/dist/components/Checkbox/Checkbox.js
var CheckboxComponent = (_param) => {
  var { children, className, style, getRootRef, description, hoverMode, activeMode, hasHover: hasHover2, hasActive, focusVisibleMode, titleAfter, noPadding } = _param, restProps = _object_without_properties(_param, [
    "children",
    "className",
    "style",
    "getRootRef",
  ...
  return (0, import_jsx_runtime209.jsxs)(SelectionControl, {
    className,
    style,
    disabled: restProps.disabled,
    getRootRef,
    ...
    noPadding,
    children: [
      (0, import_jsx_runtime209.jsx)(CheckboxInput, _object_spread({}, restProps)),
      (0, import_jsx_runtime209.jsx)(SelectionControlLabel, {
        titleAfter,
        description,
        children
      })
...
var Checkbox = (props) => {
  ...
  if (simple) {
    return (0, import_jsx_runtime209.jsx)(CheckboxSimple, _object_spread({}, props));
  }
  return (0, import_jsx_runtime209.jsx)(CheckboxComponent, _object_spread({}, props));
};
...
var SelectTypography = (_param) => {
  ...
  return (0, import_jsx_runtime210.jsx)(Text, _object_spread_props(_object_spread({
...
var NativeSelect = (_param) => {
  var { style, align, placeholder, children, className, getRef, getRootRef, disabled, multiline, selectType = "default", status, icon = (0, import_jsx_runtime211.jsx)(DropdownIcon, {}), before, onChange, value, defaultValue } = _param, restProps = _object_without_properties(_param, [
    "style",
    "align",
    "placeholder",
    "children",
  ...
  const [title, setTitle] = React208.useState("");
  const [empty, setEmpty] = React208.useState(false);
  ...
  return (0, import_jsx_runtime211.jsxs)(FormField, {
    Component: "div",
    ...
    children: [
      (0, import_jsx_runtime211.jsxs)("select", _object_spread_props(_object_spread({}, restProps), {
        ...
        ref: selectRef,
        children: [
          placeholder && (0, import_jsx_runtime211.jsx)("option", {
      ...
      (0, import_jsx_runtime211.jsx)("div", {
        className: "vkuiSelect__container",
        "aria-hidden": true,
        children: (0, import_jsx_runtime211.jsx)(SelectTypography, {
...
var CustomSelectInput = (_param) => {
  ...
  const input = (0, import_jsx_runtime212.jsx)(Text, _object_spread_props(_object_spread({
    type: "text"
  }, restProps), {
    ...
    Component: "input",
    normalize: false,
    className: clsx("vkuiCustomSelectInput__el", (restProps.readOnly || showLabelOrPlaceholder && !focusWithin) && "vkuiCustomSelectInput__elCursorPointer"),
    getRootRef: getRef,
    placeholder: children ? "" : placeholder
  }));
  const inputHidden = React209.useMemo(() => {
    if (accessible) {
      if (!searchable) {
        return true;
      }
  ...
  const platform3 = usePlatform();
  return (0, import_jsx_runtime212.jsx)(FormField, {
    Component: "div",
    style,
    ...
    mode: getFormFieldModeFromSelectType(selectType),
    status,
    children: (0, import_jsx_runtime212.jsxs)("div", {
      ...
      children: [
        ...
        restProps.readOnly && platform3 === "ios" ? (0, import_jsx_runtime212.jsx)(VisuallyHidden, {
          children: input
        }) : input
      ]
    })
...
var warn20 = warnOnce("CustomSelect");
var checkOptionsValueType = (options) => {
  if (new Set(options.map((item) => typeof item.value)).size > 1) {
    warn20("Некоторые значения ваших опций имеют разные типы. onChange всегда возвращает строковый тип.", "error");
  }
};
var checkMixControlledAndUncontrolledState = (oldIsControlled, newIsControlled) => {
  if (!oldIsControlled && newIsControlled) {
    warn20(`Похоже, что компонент был переведен из состояния Uncontrolled в Controlled. Пожалуйста, не делайте так. Если вам нужно отобразить невыбранное состояние компонента, используйте value=null вместо undefined`, "error");
  }
  if (oldIsControlled && !newIsControlled) {
    warn20(`Похоже, что компонент был переведен из состояния Controlled в Uncontrolled. Пожалуйста, не делайте так. Если вам нужно отобразить невыбранное состояние компонента, используйте value=null вместо undefined`, "error");
  }
};
...
var CustomSelectClearButton = (_param) => {
  ...
  return (0, import_jsx_runtime213.jsx)(IconButton, _object_spread_props(_object_spread({
    Component: "button",
    label: "Очистить поле",
    onKeyDown: stopPropagation,
    type: "button",
    ...
    children: (0, import_jsx_runtime213.jsx)(Icon16Cancel, {})
  }));
};
...
function useAfterItems({ value, nativeSelectValue, isControlledOutside, opened, allowClearButton, ClearButton = CustomSelectClearButton, onClearButtonClick, clearButtonTestId, disabled, readOnly, icon: iconProp }) {
  ...
  const clearButton = React211.useMemo(() => {
    if (!clearButtonShown) {
      return null;
    }
    return (0, import_jsx_runtime214.jsx)(ClearButton, {
  ...
  const icon = React211.useMemo(() => {
    if (iconProp !== void 0) {
      return iconProp;
    }
    return (0, import_jsx_runtime214.jsx)(DropdownIcon, {
  ...
  return React211.useMemo(() => !readOnly && (icon || clearButtonShown) && (0, import_jsx_runtime214.jsxs)(React211.Fragment, {
    children: [
      clearButton,
      icon
    ]
...
function useDropdownOpenedController({ onClose, onOpen, onOpened, onClosed }) {
  const [opened, setOpened] = React212.useState(false);
  ...
  const close = React212.useCallback(() => {
    if (!opened) {
      return;
    }
    setOpened(false);
  ...
  const open = React212.useCallback(() => {
    if (opened) {
      return;
    }
    setOpened(true);
  ...
  const toggleOpened = React212.useCallback(() => {
    if (opened) {
      close();
    } else {
      open();
...
function useFocusedOptionController({ selectedOptionValue, filteredOptions, scrollToElement }) {
  const [focusedOptionValue, setFocusedOptionValue] = React213.useState(null);
  const focusOptionByIndex = React213.useCallback((index2, scrollTo = true) => {
  ...
  const resetFocusedOption = React213.useCallback(() => {
    setFocusedOptionValue(null);
  }, []);
  const focusOption = React213.useCallback((type) => {
  ...
  const selectFocusedValue = React213.useCallback(() => setFocusedOptionValue(selectedOptionValue), [
    selectedOptionValue
  ]);
  return {
    focusedOptionValue,
...
function useInputKeyboardController({ opened, resetFocusedOption, focusOption, scrollBoxRef, selectFocused, onInputKeyDown, open, close }) {
  const handleKeyDownSelect = React214.useCallback((event) => {
    const key = pressedKey(event);
  ...
  const handleInputKeydown = React214.useCallback((event) => {
...
function useInputValueController({ options, accessible, selectedValue, onInputChange: onInputChangeProp }) {
  const [inputValue, setInputValue] = React215.useState("");
  const optionsRef = React215.useRef(options);
  useIsomorphicLayoutEffect(() => {
    optionsRef.current = options;
  }, [
    options
  ]);
  const resetInputValueBySelectedOption = React215.useCallback(() => {
  ...
  const resetInputValue = React215.useCallback(() => {
    setInputValue("");
  }, []);
  const onInputChange = React215.useCallback((e) => {
...
function useScrollListController() {
  const scrollBoxRef = React216.useRef(null);
  const optionsWrapperRef = React216.useRef(null);
  const scrollToElement = React216.useCallback((index2, center = false) => {
...
function useSelectedOptionController({ value, defaultValue, isControlledOutside, allowClearButton, onChange }) {
  ...
  const nativeSelectValueRef = React217.useRef(nativeSelectValue);
  const [selectedOptionValue, setSelectedOptionValue] = React217.useState(() => remapFromNativeValueToSelectValue(nativeSelectValue));
  const _setNativeSelectValue = React217.useCallback((newValue) => {
    setNativeSelectValue(newValue);
    nativeSelectValueRef.current = newValue;
  }, [
    setNativeSelectValue
  ]);
  React217.useEffect(function syncNativeSelectValueWithPropValue() {
    if (value !== void 0) {
  ...
  React217.useEffect(function syncNativeSelectValueWithSelectedOptionValue() {
...
function defaultRenderOptionFn(_param) {
  ...
  return (0, import_jsx_runtime215.jsx)(CustomSelectOption, _object_spread({}, props));
}
...
var FetchingStatus = ({ fetching = false, options, fetchingInProgressLabel = "Список опций загружается...", fetchingCompletedLabel = `Загружено опций: ${options.length}` }) => {
  const [status, setStatus] = React218.useState("none");
  ...
  return (0, import_jsx_runtime215.jsx)(VisuallyHidden, {
    "aria-live": "polite",
    children: content
  });
};
function CustomSelect(props) {
  ...
  const { sizeY = "none" } = useAdaptivity();
  const containerRef = React218.useRef(null);
  const handleRootRef = useExternRef(containerRef, getRootRef);
  const selectElRef = useExternRef(getRef);
  const selectInputRef = useExternRef(getSelectInputRef);
  const propsValue = React218.useMemo(() => {
  ...
  const [isControlledOutside, setIsControlledOutside] = React218.useState(props.value !== void 0);
  const [popperPlacement, setPopperPlacement] = React218.useState(popupDirection);
  ...
  const selected = React218.useMemo(() => options.find((option) => option.value === selectedOptionValue), [
    options,
    selectedOptionValue
  ]);
  ...
  const filteredOptions = React218.useMemo(() => filter(options, searchable ? inputValue : "", filterFn), [
    filterFn,
    inputValue,
    options,
    searchable
  ...
  React218.useEffect(function updateOptionsValue() {
  ...
  React218.useEffect(function syncIsControlledState() {
  ...
  const openedClassNames = React218.useMemo(() => opened && dropdownOffsetDistance === 0 && (popperPlacement.includes("top") ? "vkuiCustomSelect__popUp" : "vkuiCustomSelect__popDown") || void 0, [
    dropdownOffsetDistance,
    opened,
    popperPlacement
  ]);
  const selectOption = React218.useCallback((value) => {
  ...
  const selectFocused = React218.useCallback(() => {
  ...
  const onBlur = React218.useCallback(() => {
    var _selectElRef_current;
    close();
  ...
  const onFocus = React218.useCallback(() => {
    var _selectElRef_current;
  ...
  const handleOptionClick = React218.useCallback((e) => {
  ...
  const lastMousePositionRef = React218.useRef({
    x: 0,
    y: 0
  });
  const focusOptionOnMouseMove = React218.useCallback((e, index2) => {
  ...
  const popupAriaId = React218.useId();
  const renderOption = React218.useCallback((option, index2) => {
    const hovered = option.value === focusedOptionValue;
    const selected2 = option.value === selectedOptionValue;
    return (0, import_jsx_runtime215.jsx)(React218.Fragment, {
  ...
  const resolvedContent = React218.useMemo(() => {
    const defaultDropdownContent = filteredOptions.length > 0 ? (0, import_jsx_runtime215.jsx)("div", {
      ref: optionsWrapperRef,
      children: filteredOptions.map(renderOption)
    }) : (0, import_jsx_runtime215.jsx)(Footnote, {
  ...
  const { document: document2 } = useDOM();
  const passClickAndFocusToInputOnClick = React218.useCallback((e) => {
  ...
  const resetOptionFocusOnMouseLeave = React218.useCallback((event) => {
  ...
  return (0, import_jsx_runtime215.jsxs)("div", {
    className: clsx("vkuiCustomSelect__host", sizeY !== "regular" && sizeYClassNames35[sizeY], className),
    style,
    ref: handleRootRef,
    ...
    children: [
      (0, import_jsx_runtime215.jsx)(CustomSelectInput, _object_spread_props(_object_spread({
        autoComplete: "off",
        autoCapitalize: "none",
        autoCorrect: "off",
        spellCheck: "false"
        ...
        accessible,
        value: inputValue,
        onKeyDown: !readOnly ? onInputKeyDown : void 0,
        onChange: onInputChange,
        onClick: !readOnly ? toggleOpened : void 0,
        before,
        after: afterItems,
        selectType,
        children: selected === null || selected === void 0 ? void 0 : selected.label
      })),
      (0, import_jsx_runtime215.jsx)(FetchingStatus, {
        fetching,
        options: filteredOptions,
        fetchingInProgressLabel,
        fetchingCompletedLabel
      }),
      (0, import_jsx_runtime215.jsxs)("select", {
        tabIndex: -1,
        ref: selectElRef,
        name,
        ...
        required,
        children: [
          (allowClearButton || nativeSelectValue === NOT_SELECTED.NATIVE) && (0, import_jsx_runtime215.jsx)("option", {
            value: NOT_SELECTED.NATIVE
          }, NOT_SELECTED.NATIVE),
          options.map((item) => (0, import_jsx_runtime215.jsx)("option", {
            value: item.value
          }, `${item.value}`))
        ]
      }),
      opened && (0, import_jsx_runtime215.jsx)(CustomSelectDropdown, {
...
var Select = (_param) => {
  ...
  return (0, import_jsx_runtime216.jsxs)(React219.Fragment, {
    children: [
      deviceType.desktop && (0, import_jsx_runtime216.jsx)(CustomSelect, _object_spread({
        className: clsx(className, deviceType.desktop.className)
      }, props)),
      deviceType.mobile && (0, import_jsx_runtime216.jsx)(NativeSelect, _object_spread_props(_object_spread({
        className: clsx(className, deviceType.mobile.className)
      }, nativeProps), {
        children: options.map(({ label, value, disabled }) => (0, import_jsx_runtime216.jsx)("option", {
          value,
          disabled,
          children: label
        }, `${value}`))
...
var SelectMimicry = (_param) => {
  var { tabIndex = 0, placeholder, children, align, getRootRef, multiline, disabled, onClick, before, after = (0, import_jsx_runtime217.jsx)(DropdownIcon, {}), selectType = "default", status, className, autoFocus } = _param, restProps = _object_without_properties(_param, [
    "tabIndex",
    "placeholder",
    "children",
    "align",
  ...
  return (0, import_jsx_runtime217.jsx)(FormField, _object_spread_props(_object_spread({}, restProps), {
    ...
    mode: getFormFieldModeFromSelectType(selectType),
    status,
    children: (0, import_jsx_runtime217.jsx)("div", {
      className: "vkuiSelect__container",
      children: (0, import_jsx_runtime217.jsx)(SelectTypography, {
        selectType,
        className: "vkuiSelect__title",
        children: title
      })
...
var SegmentedControlOption = ({ getRef, children, getRootRef, before, rootProps, inputProps }) => (0, import_jsx_runtime218.jsxs)(Clickable, _object_spread_props(_object_spread({
  Component: "label",
  ...
  children: [
    inputProps && (0, import_jsx_runtime218.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, inputProps), {
      Component: "input",
      getRootRef: getRef,
      type: "radio"
    })),
    hasReactNode(before) && (0, import_jsx_runtime218.jsx)("div", {
      className: "vkuiSegmentedControlOption__before",
      children: before
    }),
    (0, import_jsx_runtime218.jsx)(Headline, {
      level: "2",
      weight: "2",
      children
    })
...
var warn21 = warnOnce("SegmentedControl");
var SegmentedControl = (_param) => {
  var { size: size4 = "l", name, options, defaultValue = (_options_ = options[0]) === null || _options_ === void 0 ? void 0 : _options_.value, children, onChange: onChangeProp, value: valueProp, role = "radiogroup" } = _param, restProps = _object_without_properties(_param, [
    "size",
    "name",
    "options",
    "defaultValue",
  ...
  useIsomorphicLayoutEffect(() => {
    if (actualIndex === -1 && true) {
      warn21("defaultValue: такого значения нет среди опций!", "error");
    }
  }, [
    actualIndex
  ]);
  ...
  return (0, import_jsx_runtime219.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiSegmentedControl__host", sizeY !== "compact" && sizeYClassNames37[sizeY], size4 === "l" && "vkuiSegmentedControl__sizeL", isRtl && "vkuiSegmentedControl__rtl"),
    children: (0, import_jsx_runtime219.jsxs)("div", {
      role,
      ref: tabsRef,
      className: "vkuiSegmentedControl__in",
      children: [
        actualIndex > -1 && (0, import_jsx_runtime219.jsx)("div", {
          "aria-hidden": true,
        ...
        options.map((_param2) => {
          ...
          return (0, import_jsx_runtime219.jsx)(SegmentedControlOption, {
            before,
...
function useCalendar({ value, disablePast, disableFuture, shouldDisableDate, onHeaderChange, onNextMonth, onPrevMonth, minDateTime, maxDateTime }) {
  var _ref;
  const [viewDate, setViewDate] = React223.useState((_ref = Array.isArray(value) ? value[0] : value) !== null && _ref !== void 0 ? _ref : /* @__PURE__ */ new Date());
  const [focusedDay, setFocusedDay] = React223.useState();
  const setPrevMonth = React223.useCallback(() => {
  ...
  const setNextMonth = React223.useCallback(() => {
  ...
  const handleSetViewDate = React223.useCallback((value2) => {
    onHeaderChange === null || onHeaderChange === void 0 ? void 0 : onHeaderChange(value2);
    setViewDate(value2);
  }, [
    onHeaderChange
  ]);
  const isDayFocused = React223.useCallback((day) => Boolean(focusedDay && isSameDate(day, focusedDay)), [
    focusedDay
  ]);
  const isDayDisabled = React223.useCallback((day, withTime) => {
  ...
  const isMonthDisabled = React223.useCallback((month, year) => {
    const now2 = /* @__PURE__ */ new Date();
  ...
  const isYearDisabled = React223.useCallback((year) => {
    const now2 = /* @__PURE__ */ new Date();
    const minYear = (minDateTime === null || minDateTime === void 0 ? void 0 : minDateTime.getFullYear()) || DEFAULT_MIN_YEAR;
    const maxYear = (maxDateTime === null || maxDateTime === void 0 ? void 0 : maxDateTime.getFullYear()) || DEFAULT_MAX_YEAR;
...
function useTodayDate(listenDayChangesForUpdate = false) {
  ...
  const [todayDate, setTodayDate] = React224.useState(() => /* @__PURE__ */ new Date());
  React224.useEffect(function setupTodaysDateRecalculationListener() {
...
var CalendarDay = React225.memo((_param) => {
  var { day, today, selected, onChange, hidden, disabled, active, selectionStart, selectionEnd, focused, onEnter, onLeave, onFocus, onBlur, hinted, hintedSelectionStart, hintedSelectionEnd, sameMonth, size: size4, children, renderDayContent, testId, role, "aria-colindex": colIndex } = _param, restProps = _object_without_properties(_param, [
    "day",
    "today",
    "selected",
    "onChange",
  ...
  const onClick = React225.useCallback(() => onChange(day), [
    day,
    onChange
  ]);
  const handleEnter = React225.useCallback(() => onEnter === null || onEnter === void 0 ? void 0 : onEnter(day), [
    day,
    onEnter
  ]);
  const handleLeave = React225.useCallback(() => onLeave === null || onLeave === void 0 ? void 0 : onLeave(day), [
    day,
    onLeave
  ]);
  const handleFocus = React225.useCallback(() => onFocus === null || onFocus === void 0 ? void 0 : onFocus(day), [
    day,
    onFocus
  ]);
  ...
  const content = React225.useMemo(() => {
    if (renderDayContent) {
      return renderDayContent(day);
    }
    return (0, import_jsx_runtime220.jsxs)("div", {
      className: "vkuiCalendarDay__dayNumber",
      children: [
        (0, import_jsx_runtime220.jsx)(VisuallyHidden, {
          children: children !== null && children !== void 0 ? children : label
        }),
        (0, import_jsx_runtime220.jsx)("span", {
          "aria-hidden": true,
  ...
  if (hidden) {
    return (0, import_jsx_runtime220.jsx)("div", {
      role,
      "aria-colindex": colIndex,
      className: clsx("vkuiCalendarDay__hidden", size4 === "s" && "vkuiCalendarDay__sizeS")
    });
  }
  return (0, import_jsx_runtime220.jsx)(Tappable, _object_spread_props(_object_spread({
    baseClassName: clsx("vkuiCalendarDay__host", size4 === "s" && "vkuiCalendarDay__sizeS", direction === "rtl" && "vkuiCalendarDay__rtl", focusVisibleClassNames),
    role,
    "aria-colindex": colIndex,
    ...
    children: (0, import_jsx_runtime220.jsx)("div", {
      className: clsx("vkuiCalendarDay__content", size4 === "s" && "vkuiCalendarDay__sizeS", today && "vkuiCalendarDay__today", selected && !disabled && "vkuiCalendarDay__selected", selectionStart && "vkuiCalendarDay__selectionStart", selectionEnd && "vkuiCalendarDay__selectionEnd", disabled && "vkuiCalendarDay__disabled", !sameMonth && "vkuiCalendarDay__notSameMonth"),
      children: (0, import_jsx_runtime220.jsx)("div", {
...
var CalendarDays = (_param) => {
  var { viewDate, value, weekStartsOn, onDayChange, isDaySelected, isDayActive, isDaySelectionEnd, isDaySelectionStart, onDayEnter, onDayLeave, onDayFocus, isDayHinted, isHintedDaySelectionStart, isHintedDaySelectionEnd, isDayFocused, isDayFocusable, isDayDisabled, size: size4, showNeighboringMonth = false, dayProps, listenDayChangesForUpdate = false, getRootRef, renderDayContent, dayTestId } = _param, props = _object_without_properties(_param, [
    "viewDate",
    "value",
    "weekStartsOn",
    "onDayChange",
  ...
  const weeks = React226.useMemo(() => getWeeks(viewDate, weekStartsOn), [
    weekStartsOn,
    viewDate
  ]);
  const daysNames = React226.useMemo(() => getDaysNames(now2, weekStartsOn, locale), [
    locale,
    now2,
    weekStartsOn
  ]);
  const handleDayChange = React226.useCallback((date) => {
    onDayChange(date);
  }, [
    onDayChange
  ]);
  const viewDateLabelId = React226.useId();
  const currentMonthLabel = value ? new Intl.DateTimeFormat(locale, {
    year: "numeric",
    month: "long"
  }).format(viewDate) : null;
  return (0, import_jsx_runtime221.jsxs)(React226.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime221.jsxs)(RootComponent, _object_spread_props(_object_spread({
        role: "grid"
      }, props), {
        baseClassName: "vkuiCalendarDays__host",
        "aria-labelledby": viewDateLabelId,
        children: [
          (0, import_jsx_runtime221.jsx)("div", {
            role: "row",
            "aria-rowindex": 1,
            className: clsx("vkuiCalendarDays__row", size4 === "s" && "vkuiCalendarDays__rowSizeS"),
            children: daysNames.map(({ short: shortDayName, long: longDayName }) => (0, import_jsx_runtime221.jsx)(Footnote, {
              role: "columnheader",
          ...
          weeks.map((week, i) => (0, import_jsx_runtime221.jsx)("div", {
            role: "row",
            "aria-rowindex": i + 2,
            className: clsx("vkuiCalendarDays__row", size4 === "s" && "vkuiCalendarDays__rowSizeS"),
            children: week.map((day, i2) => {
              ...
              return (0, import_jsx_runtime221.jsx)(CalendarDay, _object_spread_props(_object_spread({
                role: "gridcell",
...
var AdaptivityProvider = ({ viewWidth, viewHeight, sizeX: sizeXProp, sizeY: sizeYProp, hasPointer, hasHover: hasHover2, children }) => {
  const adaptivity = React227.useMemo(() => {
    const nextProps = {
      viewWidth,
      viewHeight,
      sizeX: sizeXProp,
  ...
  return (0, import_jsx_runtime222.jsx)(AdaptivityContext.Provider, {
    value: adaptivity,
    children
  });
};
...
var CalendarHeader = (_param) => {
  var { viewDate, onChange, prevMonthHidden: prevMonthHiddenProp = false, nextMonthHidden: nextMonthHiddenProp = false, disablePickers = false, onNextMonth, onPrevMonth, prevMonthProps = {}, nextMonthProps = {}, prevMonthLabel = "Предыдущий месяц", nextMonthLabel = "Следующий месяц", changeMonthLabel = "Изменить месяц", changeYearLabel = "Изменить год", prevMonthIcon = (0, import_jsx_runtime223.jsx)(Icon20ChevronLeftOutline, {
    className: "vkuiCalendarHeader__navIconAccent",
    width: 30,
    height: 30
  }), nextMonthIcon = (0, import_jsx_runtime223.jsx)(Icon20ChevronRightOutline, {
    className: "vkuiCalendarHeader__navIconAccent",
    width: 30,
    height: 30
  ...
  const { locale, direction } = useConfigProvider();
  const onMonthsChange = React228.useCallback((_, newValue) => onChange(setMonth(viewDate, Number(newValue))), [
    onChange,
    viewDate
  ]);
  const onYearChange = React228.useCallback((_, newValue) => onChange(setYear(viewDate, Number(newValue))), [
    onChange,
    viewDate
  ]);
  const currentYear = viewDate.getFullYear();
  const currentMonth = viewDate.getMonth();
  const months = React228.useMemo(() => getMonths(locale).map(({ value, label }) => ({
    value,
    label: (0, import_jsx_runtime223.jsx)("span", {
  ...
  const years = React228.useMemo(() => getYears(currentYear, 100).map((year) => _object_spread_props(_object_spread({}, year), {
  ...
  return (0, import_jsx_runtime223.jsxs)(RootComponent, _object_spread_props(_object_spread({
    baseClassName: "vkuiCalendarHeader__host"
  }, restProps), {
    children: [
      !prevMonthHidden && (0, import_jsx_runtime223.jsx)(AdaptivityProvider, {
        sizeX: "regular",
        children: (0, import_jsx_runtime223.jsxs)(Tappable, _object_spread_props(_object_spread({
          ...
          children: [
            (0, import_jsx_runtime223.jsxs)(VisuallyHidden, {
              children: [
                prevMonthLabel,
                ", ",
      ...
      disablePickers ? (0, import_jsx_runtime223.jsxs)(Paragraph, {
        className: clsx("vkuiCalendarHeader__pickers", "vkuiInternalCalendarHeader__pickers"),
        weight: "2",
        children: [
          (0, import_jsx_runtime223.jsx)("span", {
            className: "vkuiCalendarHeader__month",
      ...
      }) : (0, import_jsx_runtime223.jsx)(AdaptivityProvider, {
        sizeY: "compact",
        children: (0, import_jsx_runtime223.jsxs)("div", {
          className: clsx("vkuiCalendarHeader__pickers", "vkuiInternalCalendarHeader__pickers"),
          children: [
            (0, import_jsx_runtime223.jsx)(CustomSelect, {
              className: clsx("vkuiCalendarHeader__picker", "vkuiInternalCalendarHeader__picker"),
              value: currentMonth,
              options: months,
              dropdownOffsetDistance: 4,
              dropdownAutoWidth: true,
              icon: (0, import_jsx_runtime223.jsx)(Icon12Dropdown, {}),
      ...
      !nextMonthHidden && (0, import_jsx_runtime223.jsx)(AdaptivityProvider, {
        sizeX: "regular",
        children: (0, import_jsx_runtime223.jsxs)(Tappable, _object_spread_props(_object_spread({
...
var CalendarTime = ({ value, onChange, onDoneButtonClick, changeHoursLabel, changeMinutesLabel, isDayDisabled, doneButtonText = "Готово", doneButtonDisabled = false, doneButtonShow = true, minutesTestId, hoursTestId, doneButtonTestId, DoneButton }) => {
  ...
  const onHoursChange = React229.useCallback((_, newValue) => onChange === null || onChange === void 0 ? void 0 : onChange(setHours(value, Number(newValue))), [
    onChange,
    value
  ]);
  const onMinutesChange = React229.useCallback((_, newValue) => onChange === null || onChange === void 0 ? void 0 : onChange(setMinutes(value, Number(newValue))), [
    onChange,
    value
  ]);
  ...
  const stopPropogationOfEscapeKeyboardEventWhenSelectIsOpen = React229.useCallback((event, isOpen) => {
    if (isOpen && event.key === "Escape") {
      event.stopPropagation();
    }
  }, []);
  ...
  const renderDoneButton = () => {
    ...
    return (0, import_jsx_runtime224.jsx)(ButtonComponent, {
      mode: "secondary",
  ...
  return (0, import_jsx_runtime224.jsxs)("div", {
    className: clsx("vkuiCalendarTime__host", !doneButtonShow && "vkuiCalendarTime__host__withoutDone"),
    children: [
      (0, import_jsx_runtime224.jsx)("div", {
        className: "vkuiCalendarTime__picker",
        children: (0, import_jsx_runtime224.jsx)(AdaptivityProvider, {
          sizeY: "compact",
          children: (0, import_jsx_runtime224.jsx)(CustomSelect, {
      ...
      doneButtonShow && (0, import_jsx_runtime224.jsx)("div", {
...
// node_modules/@vkontakte/vkui/dist/components/Calendar/Calendar.js
var warn22 = warnOnce("Calendar");
var Calendar = (_param) => {
  var { getRootRef, "value": valueProp, defaultValue, onChange, disablePast, disableFuture, shouldDisableDate, onDoneButtonClick, enableTime = false, doneButtonText, doneButtonDisabled, doneButtonShow, DoneButton, weekStartsOn = 1, disablePickers, "aria-label": ariaLabel = "Календарь", changeHoursLabel = "Изменить час", changeMinutesLabel = "Изменить минуту", prevMonthLabel = "Предыдущий месяц", nextMonthLabel = "Следующий месяц", changeMonthLabel = "Изменить месяц", changeYearLabel = "Изменить год", showNeighboringMonth, size: size4 = "m", "viewDate": externalViewDate, onHeaderChange, onNextMonth, onPrevMonth, prevMonthIcon, nextMonthIcon, prevMonthProps, nextMonthProps, dayProps, listenDayChangesForUpdate, renderDayContent, minDateTime, maxDateTime, timezone, minutesTestId, hoursTestId, doneButtonTestId, prevMonthButtonTestId, nextMonthButtonTestId, monthDropdownTestId, yearDropdownTestId, dayTestId } = _param, props = _object_without_properties(_param, [
    "getRootRef",
    "value",
    "defaultValue",
    "onChange",
  ...
  const _onChange = React230.useCallback((date) => {
  ...
  const timeZonedValue = React230.useMemo(() => convertDateToTimeZone(value, timezone), [
    timezone,
    value
  ]);
  ...
  const [focusableDay, setFocusableDay] = React230.useState();
  useIsomorphicLayoutEffect(() => {
    if (timeZonedValue) {
  ...
  if (!disablePickers && size4 === "s") {
    warn22("Нельзя включить селекты выбора месяца/года, если размер календаря 's'", "error");
  }
  if (enableTime && size4 === "s") {
    warn22("Нельзя включить выбор времени, если размер календаря 's'", "error");
  }
  const handleKeyDown = React230.useCallback((event) => {
    const key = pressedKey(event);
  ...
  const onDayChange = React230.useCallback((date) => {
  ...
  const onDayFocus = React230.useCallback((date) => {
  ...
  const isDayActive = React230.useCallback((day) => Boolean(timeZonedValue && isSameDate(day, timeZonedValue)), [
    timeZonedValue
  ]);
  ...
  return (0, import_jsx_runtime225.jsxs)(RootComponent, _object_spread_props(_object_spread({
    "aria-label": ariaLabel
  }, props), {
    baseClassName: clsx("vkuiCalendar__host", size4 === "s" && "vkuiCalendar__sizeS"),
    getRootRef,
    children: [
      (0, import_jsx_runtime225.jsx)(CalendarHeader, {
      ...
      (0, import_jsx_runtime225.jsx)(CalendarDays, {
        viewDate: externalViewDate || viewDate,
        value: timeZonedValue,
        weekStartsOn,
        onKeyDown: handleKeyDown,
      ...
      enableTime && timeZonedValue && size4 !== "s" && (0, import_jsx_runtime225.jsx)("div", {
        className: "vkuiCalendar__time",
        children: (0, import_jsx_runtime225.jsx)(CalendarTime, {
          value: timeZonedValue,
...
function useCalendarKeyboardNavigation({ focusedDay, value, setFocusedDay, viewDates: [firstCalendarViewDate, secondCalendarViewDate], setViewDate }) {
  const [focusableDayOnFirstCalendar, setFocusableDayOnFirstCalendar] = React231.useState();
  const [focusableDayOnSecondCalendar, setFocusableDayOnSecondCalendar] = React231.useState();
  const handleCalendarKeyDown = React231.useCallback((event, isFirst) => {
    const key = pressedKey(event);
    if (!key) {
      return;
    }
  ...
  const handleFirstCalendarKeyDown = React231.useCallback((event) => {
    handleCalendarKeyDown(event, true);
  }, [
    handleCalendarKeyDown
  ]);
  const handleSecondCalendarKeyDown = React231.useCallback((event) => {
    handleCalendarKeyDown(event, false);
  }, [
    handleCalendarKeyDown
  ]);
  const handleDayFocus = React231.useCallback((value2) => {
...
function useIsDayFocusable({ value, focusableDayOnFirstCalendar, focusableDayOnSecondCalendar, viewDate, isDayActive }) {
  ...
  const isDayFocusable = React231.useCallback((day) => {
...
var CalendarRange = (_param) => {
  ...
  const _onChange = React232.useCallback((newValue) => onChange === null || onChange === void 0 ? void 0 : onChange(newValue || void 0), [
    onChange
  ]);
  const [value, updateValue] = useCustomEnsuredControl({
    value: valueProp,
  ...
  const [hintedDate, setHintedDate] = React232.useState();
  ...
  const getNewValue = React232.useCallback((date) => {
  ...
  const onDayChange = React232.useCallback((date) => {
  ...
  const isDaySelected = React232.useCallback((day) => getIsDaySelected(day, value), [
    value
  ]);
  const isDayActive = React232.useCallback((day) => Boolean((value === null || value === void 0 ? void 0 : value[0]) && isSameDate(day, value[0]) || (value === null || value === void 0 ? void 0 : value[1]) && isSameDate(day, value[1])), [
    value
  ]);
  const isDaySelectionEnd = React232.useCallback((day, dayOfWeek) => Boolean(isLastDay(day, dayOfWeek) || (value === null || value === void 0 ? void 0 : value[1]) && isSameDate(day, value[1])), [
    value
  ]);
  const isHintedDaySelectionEnd = React232.useCallback((day, dayOfWeek) => Boolean(isLastDay(day, dayOfWeek) || (hintedDate === null || hintedDate === void 0 ? void 0 : hintedDate[1]) && isSameDate(day, hintedDate[1])), [
    hintedDate
  ]);
  const isDaySelectionStart = React232.useCallback((day, dayOfWeek) => Boolean(isFirstDay(day, dayOfWeek) || (value === null || value === void 0 ? void 0 : value[0]) && isSameDate(day, value[0])), [
    value
  ]);
  const isHintedDaySelectionStart = React232.useCallback((day, dayOfWeek) => Boolean(isFirstDay(day, dayOfWeek) || (hintedDate === null || hintedDate === void 0 ? void 0 : hintedDate[0]) && isSameDate(day, hintedDate[0])), [
    hintedDate
  ]);
  const onDayEnter = React232.useCallback((date) => setHintedDate(getNewValue(date)), [
    setHintedDate,
    getNewValue
  ]);
  const onDayLeave = React232.useCallback(() => setHintedDate(void 0), [
    setHintedDate
  ]);
  const isDayHinted = React232.useCallback((day) => getIsDaySelected(day, hintedDate), [
    hintedDate
  ]);
  const onRightPartViewDateChange = React232.useCallback((newDate) => setViewDate(subMonths(newDate, 1)), [
    setViewDate
  ]);
  ...
  const onDayFocus = React232.useCallback((date) => {
    if (focusedDay && isSameDate(focusedDay, date)) {
      return;
    }
    setFocusedDay(date);
  ...
  return (0, import_jsx_runtime226.jsxs)(RootComponent, _object_spread_props(_object_spread({
    ...
    getRootRef,
    children: [
      (0, import_jsx_runtime226.jsxs)("div", {
        className: "vkuiCalendarRange__inner",
        children: [
          (0, import_jsx_runtime226.jsx)(CalendarHeader, _object_spread({
            viewDate,
            onChange: setViewDate,
...
function useDateInput({ maxElement, refs, autoFocus, disabled, elementsConfig: elementsConfig3, onClear, onInternalValueChange, getInternalValue: getInternalValue3, value, onCalendarOpenChanged, accessible }) {
  ...
  const rootRef = React233.useRef(null);
  const calendarRef = React233.useRef(null);
  const [internalValue, setInternalValue] = React233.useState([]);
  const [focusedElement, setFocusedElement] = React233.useState(null);
  const isClickedOutsideRef = React233.useRef(false);
  const { window: window2 } = useDOM();
  const handleRestoreFocus = React233.useCallback(() => {
  ...
  const resetFocusedElement = React233.useCallback(() => {
  ...
  const removeFocusFromField = React233.useCallback(() => {
    resetFocusedElement();
    _onCalendarClose();
  }, [
    resetFocusedElement,
  ...
  const handleClickOutside = React233.useCallback((e) => {
  ...
  const selectFirst = React233.useCallback(() => {
    if (focusedElement !== null) {
      return;
    }
    setFocusedElement(0);
  ...
  const clear = React233.useCallback(() => {
  ...
  const handleFieldEnter = React233.useCallback(() => {
    selectFirst();
  }, [
    selectFirst
  ]);
  const handleKeyDown = React233.useCallback((e) => {
    if (focusedElement === null) {
      return;
    }
    const _value = [
...
var InputLikeDivider = (_param) => {
  ...
  return (0, import_jsx_runtime227.jsx)("span", _object_spread_props(_object_spread({
...
function getMaskElements(length) {
  ...
  for (let index2 = 0; index2 < length; index2 += 1) {
    result.push((0, import_jsx_runtime228.jsx)("span", {
...
var InputLike = (_param) => {
  ...
  const handleElementSelect = React235.useCallback((event) => {
    stopPropagation(event);
  ...
  var _value_length;
  return (0, import_jsx_runtime228.jsxs)(RootComponent, _object_spread_props(_object_spread({
    Component: "span",
    ...
    children: [
      label && (0, import_jsx_runtime228.jsx)(VisuallyHidden, {
        children: label
      }),
      value === null || value === void 0 ? void 0 : value.slice(0, length - 1),
      (value === null || value === void 0 ? void 0 : value.slice(length - 1)) && (0, import_jsx_runtime228.jsx)("span", {
...
var NumberInputLike = (_param) => {
  ...
  return (0, import_jsx_runtime229.jsx)(InputLike, _object_spread({
    role: "spinbutton",
    value: stringValue,
    length,
...
var useDateInputValue = ({ value, defaultValue, onChange, timezone }) => {
  const [internalValue, setInternalValue] = React236.useState(getStateValue(null, value, defaultValue, timezone));
  const lastUpdatedValueRef = React236.useRef(getStateValue(null, value, defaultValue, timezone));
  const isControlled = value !== void 0;
  React236.useEffect(() => {
    if (isControlled) {
  ...
  const getLastUpdatedValue = React236.useCallback(() => lastUpdatedValueRef.current, []);
  const updateValue = React236.useCallback((newValue) => {
    if (!isControlled) {
...
var DateInput = (_param) => {
  ...
  const daysRef = React237.useRef(null);
  const monthsRef = React237.useRef(null);
  const yearsRef = React237.useRef(null);
  const hoursRef = React237.useRef(null);
  const minutesRef = React237.useRef(null);
  ...
  const onCalendarChange = React237.useCallback((value2) => {
    if (!value2) {
      return;
    }
    if (enableTime) {
  ...
  const onDoneButtonClick = React237.useCallback(() => {
    if (!value) {
      return;
    }
  ...
  const customValue = React237.useMemo(() => !open && (renderCustomValue === null || renderCustomValue === void 0 ? void 0 : renderCustomValue(value || void 0)), [
    open,
    renderCustomValue,
    value
  ]);
  ...
  return (0, import_jsx_runtime230.jsxs)(FormField, _object_spread_props(_object_spread({
    style,
    className: clsx(sizeY !== "regular" && sizeYClassNames38[sizeY], className),
    getRootRef: handleRootRef,
    role: "group",
    "aria-labelledby": `${ariaLabelId} ${currentDateLabelId}`,
    after: (0, import_jsx_runtime230.jsxs)(React237.Fragment, {
      children: [
        !disableCalendar && (accessible || !accessible && !value) ? (0, import_jsx_runtime230.jsx)(IconButton, {
          hoverMode: "opacity",
          label: showCalendarLabel,
          onClick: toggleCalendar,
          "data-testid": showCalendarButtonTestId,
          children: (0, import_jsx_runtime230.jsx)(Icon20CalendarOutline, {})
        }) : null,
        value && !readOnly ? (0, import_jsx_runtime230.jsx)(IconButton, {
          hoverMode: "opacity",
          label: clearFieldLabel,
          onClick: clear,
          "data-testid": clearButtonTestId,
          children: (0, import_jsx_runtime230.jsx)(Icon16Clear, {})
        }) : null
      ]
    }),
    disabled
    ...
    children: [
      (0, import_jsx_runtime230.jsxs)("div", {
        className: "vkuiDateInput__wrapper",
        children: [
          ariaLabel && (0, import_jsx_runtime230.jsx)(VisuallyHidden, {
            id: ariaLabelId,
            children: ariaLabel
          }),
          currentDateLabel && (0, import_jsx_runtime230.jsx)(VisuallyHidden, {
            id: currentDateLabelId,
            children: currentDateLabel
          }),
          (0, import_jsx_runtime230.jsx)(VisuallyHidden, {
            id,
            Component: "input",
            readOnly: true,
            "aria-hidden": true,
          ...
          (0, import_jsx_runtime230.jsxs)(Text, {
            ...
            children: [
              (0, import_jsx_runtime230.jsx)(NumberInputLike, {
              ...
              (0, import_jsx_runtime230.jsx)(InputLikeDivider, {
                children: "."
              }),
              (0, import_jsx_runtime230.jsx)(NumberInputLike, {
              ...
              enableTime && (0, import_jsx_runtime230.jsxs)(React237.Fragment, {
                children: [
                  (0, import_jsx_runtime230.jsx)(InputLikeDivider, {
          ...
          customValue && (0, import_jsx_runtime230.jsx)(Text, {
      ...
      open && !disableCalendar && (0, import_jsx_runtime230.jsx)(Popper, {
        targetRef: rootRef,
        offsetByMainAxis: 8,
        placement: calendarPlacement,
        onPlacementChange: setCalendarPlacement,
        autoUpdateOnTargetResize: true,
        children: (0, import_jsx_runtime230.jsx)(FocusTrap, {
          ...
          children: (0, import_jsx_runtime230.jsx)(Calendar, _object_spread({
...
var DateRangeInput = (_param) => {
  ...
  const daysStartRef = React238.useRef(null);
  const monthsStartRef = React238.useRef(null);
  const yearsStartRef = React238.useRef(null);
  const daysEndRef = React238.useRef(null);
  const monthsEndRef = React238.useRef(null);
  const yearsEndRef = React238.useRef(null);
  const disableCalendar = readOnly ? true : disableCalendarProp;
  const _onChange = React238.useCallback((newValue) => onChange === null || onChange === void 0 ? void 0 : onChange(newValue || void 0), [
    onChange
  ]);
  const [value, updateValue] = useCustomEnsuredControl({
    value: valueProp,
  ...
  const onInternalValueChange = React238.useCallback((internalValue2) => {
  ...
  const onClear = React238.useCallback(() => updateValue(void 0), [
    updateValue
  ]);
  ...
  const { sizeY = "none" } = useAdaptivity();
  const handleRootRef = useExternRef(rootRef, getRootRef);
  const onCalendarChange = React238.useCallback((newValue) => {
  ...
  const [calendarPlacement, setCalendarPlacement] = React238.useState(calendarPlacementProp);
  const { locale } = useConfigProvider();
  const currentDateLabel = React238.useMemo(() => {
    if (!value) {
      return null;
    }
  ...
  const currentDateLabelId = React238.useId();
  const ariaLabelId = React238.useId();
  const showCalendarOnInputAreaClick = React238.useCallback(() => {
    handleFieldEnter();
    if (accessible) {
      openCalendar();
    }
  ...
  return (0, import_jsx_runtime231.jsxs)(FormField, _object_spread_props(_object_spread({
    style,
    className: clsx(sizeY !== "regular" && sizeYClassNames39[sizeY], className),
    getRootRef: handleRootRef,
    role: "group",
    "aria-labelledby": `${ariaLabelId} ${currentDateLabelId}`,
    after: (0, import_jsx_runtime231.jsxs)(import_jsx_runtime231.Fragment, {
      children: [
        !disableCalendar && (accessible || !accessible && !value) ? (0, import_jsx_runtime231.jsx)(IconButton, {
          hoverMode: "opacity",
          label: showCalendarLabel,
          onClick: toggleCalendar,
          "data-testid": showCalendarButtonTestId,
        ...
        value && !readOnly ? (0, import_jsx_runtime231.jsx)(IconButton, {
          hoverMode: "opacity",
          label: clearFieldLabel,
          onClick: clear,
          "data-testid": clearButtonTestId,
    ...
    children: [
      ...
      open && !disableCalendar && (0, import_jsx_runtime231.jsx)(Popper, {
        ...
        children: (0, import_jsx_runtime231.jsx)(FocusTrap, {
          ...
          children: (0, import_jsx_runtime231.jsx)(CalendarRange, _object_spread({
            value,
            role: "dialog",
            onChange: onCalendarChange,
            "aria-label": calendarLabel,
...
function useSkeletonSyncAnimation(disableAnimation, duration = 1.5) {
  const [isAnimationStarted, setIsAnimationStarted] = React239.useState(false);
  const timer = React239.useRef(void 0);
  const syncAnimation = React239.useCallback(() => {
...
function useSkeletonPosition(rootRef) {
  ...
  const updatePosition = React239.useCallback(() => {
  ...
  React239.useEffect(updatePosition, [
    updatePosition
  ]);
...
var Skeleton = (_param) => {
  ...
  return (0, import_jsx_runtime232.jsx)(RootComponent, _object_spread_props(_object_spread({
    getRootRef: rootRef,
    Component: "span",
    ...
    children: children || (0, import_jsx_runtime232.jsx)(import_jsx_runtime232.Fragment, {
      children: "‌"
    })
  }));
};
...
var Div = (props) => (0, import_jsx_runtime233.jsx)(RootComponent, _object_spread({
...
var PanelSpinner = React241.memo((_param) => {
  var { height = 96, style } = _param, restProps = _object_without_properties(_param, [
    "height",
    "style"
  ]);
  return (0, import_jsx_runtime234.jsx)(Spinner, _object_spread_props(_object_spread({
    size: "m"
  }, restProps), {
    style: _object_spread({
      height
...
var PanelHeaderClose = (_param) => {
  ...
  const platform3 = usePlatform();
  return (0, import_jsx_runtime235.jsx)(PanelHeaderButton, _object_spread_props(_object_spread({}, restProps), {
    label: platform3 === "ios" ? label : label && (0, import_jsx_runtime235.jsx)(VisuallyHidden, {
      children: label
    }),
    children: platform3 !== "ios" && (0, import_jsx_runtime235.jsx)(AdaptiveIconRenderer, {
...
var getBackIcon = (platform3) => {
  switch (platform3) {
    case "ios":
      return (0, import_jsx_runtime236.jsx)(Icon28ChevronBack, {});
    case "vkcom":
      return (0, import_jsx_runtime236.jsx)(AdaptiveIconRenderer, {
...
var PanelHeaderBack = (_param) => {
  ...
  return (0, import_jsx_runtime236.jsx)(PanelHeaderButton, _object_spread_props(_object_spread({}, restProps), {
    ...
    label: showLabel ? label : label && (0, import_jsx_runtime236.jsx)(VisuallyHidden, {
      children: label
    }),
...
var PanelHeaderSubmit = (_param) => {
  ...
  const platform3 = usePlatform();
  return (0, import_jsx_runtime237.jsx)(PanelHeaderButton, _object_spread_props(_object_spread({
    primary: true,
    label: platform3 === "ios" ? label : label && (0, import_jsx_runtime237.jsx)(VisuallyHidden, {
      children: label
    })
  }, restProps), {
    children: platform3 !== "ios" && (0, import_jsx_runtime237.jsx)(AdaptiveIconRenderer, {
...
var PanelHeaderEdit = (_param) => {
  ...
  return (0, import_jsx_runtime238.jsx)(PanelHeaderButton, _object_spread_props(_object_spread({}, restProps), {
...
var useAutoDetectColorScheme = (colorSchemeProp) => {
  const { window: window2 } = useDOM();
  const [colorScheme, setColorScheme] = React244.useState(colorSchemeProp || ColorScheme.LIGHT);
  useIsomorphicLayoutEffect(() => {
    if (colorSchemeProp) {
...
var ConfigProvider = (propsRaw) => {
  ...
  return (0, import_jsx_runtime239.jsx)(ConfigProviderContext.Provider, {
    value: configContext,
    children: (0, import_jsx_runtime239.jsx)(IconAppearanceProvider, {
      value: colorScheme,
      children: (0, import_jsx_runtime239.jsx)(TokensClassProvider, {
...
function LocaleProvider({ value, children }) {
  return (0, import_jsx_runtime240.jsx)(ConfigProviderOverride, {
    locale: value,
    children
  });
}
...
function PlatformProvider({ value, children }) {
  return (0, import_jsx_runtime242.jsx)(ConfigProviderOverride, {
    platform: value,
    children: (0, import_jsx_runtime242.jsx)(TokensClassProvider, {
      children
    })
  });
}
...
var usePopover = (_param) => {
  ...
  const renderFloatingComponent = React250.useCallback(({ shown, middlewareData, placement: resolvedPlacement, setArrowRef, floatingRef, floatingProps, willBeHide, onRestoreFocus, onClose }) => {
    ...
    if (withArrow) {
      const { arrow: arrowCoords } = middlewareData;
      arrow4 = (0, import_jsx_runtime243.jsx)(FloatingArrow, _object_spread_props(_object_spread({
    ...
    return (0, import_jsx_runtime243.jsx)(AppRootPortal, {
      usePortal,
      children: (0, import_jsx_runtime243.jsx)("div", _object_spread_props(_object_spread({
        ref: floatingRef,
        ...
        children: (0, import_jsx_runtime243.jsxs)(FocusTrap, _object_spread_props(_object_spread({}, restPopoverProps), {
          role,
...
var Popover = (_param) => {
  ...
  return (0, import_jsx_runtime244.jsxs)(React251.Fragment, {
    children: [
      reference,
      popover
    ]
...
function withPlatform(Component2) {
  function WithPlatform(props) {
    const { platform: platform3 } = useConfigProvider();
    return (0, import_jsx_runtime245.jsx)(Component2, _object_spread_props(_object_spread({}, props), {
      platform: platform3
    }));
  }
  return WithPlatform;
...
var useNavId = () => ({
  view: React253.useContext(NavViewIdContext),
  panel: React253.useContext(NavPanelIdContext)
});
...
var SSRWrapper = ({ userAgent, browserInfo, direction = "ltr", children }) => {
  ...
  return (0, import_jsx_runtime246.jsx)(ConfigProviderOverride, {
    direction,
...
function withContext(Component2, Ctx, prop) {
  function WithContext(props) {
    const context = React255.useContext(Ctx);
    return (0, import_jsx_runtime247.jsx)(Component2, _object_spread_props(_object_spread({}, props), {
      [prop]: context
    }));
  }
  return WithContext;
...
// node_modules/@vkontakte/vkui/dist/components/View/ViewInfinite.js
var warn23 = warnOnce("ViewInfinite");
var scrollsCache2 = {};
var _React_Component;
var ViewInfiniteComponent = class extends (_React_Component = React256.Component) {
  get document() {
  ...
  get panels() {
    return React256.Children.toArray(this.props.children);
  }
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
      ...
      if (this.props.isBackCheck) {
        ...
        const firstLayerId = this.panels.map((panel) => getNavId(panel.props, warn23)).find((id) => id === prevProps.activePanel || id === this.props.activePanel);
  ...
  render() {
    ...
    const panels = this.panels.filter((panel) => {
      const panelId = getNavId(panel.props, warn23);
    ...
    return (0, import_jsx_runtime248.jsx)(NavViewIdContext.Provider, {
      value: id || nav,
      children: (0, import_jsx_runtime248.jsx)(Touch, _object_spread_props(_object_spread({
        Component: "section"
      }, restProps), {
        ...
        children: (0, import_jsx_runtime248.jsx)("div", {
          className: "vkuiView__panels",
          children: panels.map((panel) => {
            const panelId = getNavId(panel.props, warn23);
            ...
            return (0, import_jsx_runtime248.jsx)("div", {
              ...
              children: (0, import_jsx_runtime248.jsx)("div", {
                ...
                children: (0, import_jsx_runtime248.jsx)(NavTransitionDirectionProvider, {
                  isBack: swipingBack || isBack,
                  children: (0, import_jsx_runtime248.jsx)(NavTransitionProvider, {
                    entering: panelId === nextPanel || panelId === swipeBackNextPanel,
                    children: panel
                  })
                })
...
var ModalPageFooter = (_param) => {
  ...
  const { sizeX, isDesktop } = useAdaptivityWithJSMediaQueries();
  return (0, import_jsx_runtime249.jsxs)(RootComponent, _object_spread_props(_object_spread({
    ...
    children: [
      !noSeparator && (0, import_jsx_runtime249.jsx)(Separator, {
...
//# sourceMappingURL=chunk-KCUKQBV6.js.map

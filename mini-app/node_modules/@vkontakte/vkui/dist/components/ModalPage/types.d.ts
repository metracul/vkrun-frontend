...
export type ModalPageCloseReason = 'click-overlay' | 'click-close-button' | 'escape-key' | 'swipe-down';
...
export interface ModalPageProps extends NavIdProps, Omit<HTMLAttributesWithRootRef<HTMLDivElement>, 'id' | 'style'>, Pick<UseFocusTrapProps, 'restoreFocus'>, OmittedStyleAttribute {
    /**
     * Состояние видимости.
     *
     * @default false
     ...
     */
    size?: LiteralUnion<'s' | 'm' | 'l' | 'auto' | 'fit-content' | 'max-content' | 'min-content', string | number>;
    /**
